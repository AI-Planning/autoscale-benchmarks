; 46 floors, area size: 15, areas: 3, passengers: 34
...
(:domain elevators-sequencedstrips)
    (:objects
       ...
       p0 p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 p12 p13 p14 p15 p16 p17 p18 p19 p20 p21 p22 p23 p24 p25 p26 p27 p28 p29 p30 p31 p32 p33 - passenger
       fast0 - fast-elevator
    ...
    (:goal (and
       ...
       (passenger-at p8 n39)
       (passenger-at p9 n0)
       (passenger-at p10 n19)
       (passenger-at p11 n37)
       (passenger-at p12 n18)
       (passenger-at p13 n14)
       (passenger-at p14 n32)
       (passenger-at p15 n39)
       (passenger-at p16 n5)
       (passenger-at p17 n10)
       (passenger-at p18 n24)
       (passenger-at p19 n40)
       (passenger-at p20 n22)
       (passenger-at p21 n12)
       (passenger-at p22 n11)
       (passenger-at p23 n15)
       (passenger-at p24 n1)
       (passenger-at p25 n43)
       (passenger-at p26 n30)
       (passenger-at p27 n14)
       (passenger-at p28 n45)
       (passenger-at p29 n11)
       (passenger-at p30 n29)
       (passenger-at p31 n34)
