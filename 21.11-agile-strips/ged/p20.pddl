...
;; simplified sequence 1: (1 25 2 23 17 12 3 20 6 15 30 27 31 18 -19 -9 -21 -8 -7 33 -28 10 11 32 -4 -24 -13 -34 -14 26 5 35 -22 -29 -16 -36)
...
(DEFINE (PROBLEM ARTEMIA-FRANCISCANA-TO-ONCHOCERCA-VOLVULUS)
        ...
        (:INIT (NORMAL COX1) (NORMAL L2) (NORMAL COX2) (NORMAL K)
               ...
               (INVERTED V) (INVERTED RRNS) (NORMAL M) (NORMAL NAD2)
               ...
               (PRESENT N) (PRESENT S1) (PRESENT E) (PRESENT F)
               ...
               (PRESENT RRNL) (PRESENT V) (PRESENT RRNS) (PRESENT M)
               (PRESENT NAD2) (PRESENT W) (PRESENT I) (PRESENT Q)
               (PRESENT C) (PRESENT Y) (CW Y COX1) (CW C Y) (CW Q C)
               (CW I Q) (CW W I) (CW NAD2 W) (CW M NAD2) (CW RRNS M)
               (CW V RRNS) (CW RRNL V) (CW L1 RRNL) (CW NAD1 L1)
               (CW S2 NAD1) (CW COB S2) (CW NAD6 COB) (CW P NAD6)
               (CW T P) (CW NAD4L T) (CW NAD4 NAD4L) (CW H NAD4)
               (CW NAD5 H) (CW F NAD5) (CW E F) (CW S1 E) (CW N S1)
               (CW R N) (CW A R) (CW NAD3 A) (CW G NAD3) (CW COX3 G)
               (CW ATP6 COX3) (CW D ATP6) (CW K D) (CW COX2 K)
               (CW L2 COX2) (CW COX1 L2) (IDLE) (= (TOTAL-COST) 0))
