...
;; simplified sequence 2: (1 -32 17 2 23 12 3 20 6 30 7 8 21 31 24 9 -10 -18 11 33 -28 19 14 34 13 25 4 22 -29 26 5 35 -15 -27 -16 -36)
...
(DEFINE (PROBLEM ASCARIS-SUUM-TO-HUMAN) (:DOMAIN GENOME-EDIT-DISTANCE)
        ...
        (:GOAL (AND (NORMAL COX1) (INVERTED S2) (NORMAL D)
                    ...
                    (NORMAL COX3) (NORMAL G) (NORMAL NAD3) (NORMAL R)
                    (NORMAL NAD4L) (NORMAL NAD4) (NORMAL H) (NORMAL S1)
                    (NORMAL L1) (NORMAL NAD5) (INVERTED NAD6)
                    (INVERTED E) (NORMAL COB) (NORMAL T) (INVERTED P)
                    (NORMAL F) (NORMAL RRNS) (NORMAL V) (NORMAL RRNL)
                    (NORMAL L2) (NORMAL NAD1) (NORMAL I) (INVERTED Q)
                    (NORMAL M) (NORMAL NAD2) (NORMAL W) (INVERTED A)
                    (INVERTED N) (INVERTED C) (INVERTED Y) (CW Y COX1)
                    (CW C Y) (CW N C) (CW A N) (CW W A) (CW NAD2 W)
                    (CW M NAD2) (CW Q M) (CW I Q) (CW NAD1 I)
                    (CW L2 NAD1) (CW RRNL L2) (CW V RRNL) (CW RRNS V)
                    (CW F RRNS) (CW P F) (CW T P) (CW COB T) (CW E COB)
                    (CW NAD6 E) (CW NAD5 NAD6) (CW L1 NAD5) (CW S1 L1)
                    (CW H S1) (CW NAD4 H) (CW NAD4L NAD4) (CW R NAD4L)
                    (CW NAD3 R) (CW G NAD3) (CW COX3 G) (CW ATP6 COX3)
                    (CW K ATP6) (CW COX2 K) (CW D COX2) (CW S2 D)
                    (CW COX1 S2)))
