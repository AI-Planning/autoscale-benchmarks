...
;
; Map of the Depots:                                                                                                                                  
; 0000 1111 2222=3333=4444 5555 6666=7777 8888=9999 AAAA BBBB CCCC DDDD EEE                                                       
; 00 * 1*11 2*2  333* 44 * 55*  *666 77*  88*8 99*  AA*  B*BB *CC  D*DD EEE                                                       
;                                                                       EE*                                                       
;--------------------------------------------------------------------------                                                       
; 48: depot48 area
; 49: depot49 area
...
(:objects
	depot48-1-1 depot48-1-2 depot48-1-3 depot48-1-4 depot48-2-1 depot48-2-2 depot48-2-4 depot49-1-1 depot49-1-2 depot49-1-3 depot49-1-4 depot49-2-1 depot49-2-2 depot49-2-3 depot49-2-4 depot50-1-1 depot50-1-2 depot50-1-3 depot50-1-4 depot50-2-1 depot50-2-2 depot50-2-3 depot51-1-1 depot51-1-2 depot51-1-3 depot51-1-4 depot51-2-1 depot51-2-2 depot51-2-3 depot51-2-4 depot52-1-1 depot52-1-2 depot52-1-3 depot52-1-4 depot52-2-1 depot52-2-2 depot52-2-4 depot53-1-1 depot53-1-2 depot53-1-3 depot53-1-4 depot53-2-1 depot53-2-2 depot53-2-3 depot54-1-1 depot54-1-2 depot54-1-3 depot54-1-4 depot54-2-1 depot54-2-2 depot54-2-3 depot54-2-4 depot55-1-1 depot55-1-2 depot55-1-3 depot55-1-4 depot55-2-1 depot55-2-2 depot55-2-3 depot56-1-1 depot56-1-2 depot56-1-3 depot56-1-4 depot56-2-1 depot56-2-2 depot56-2-3 depot56-2-4 depot57-1-1 depot57-1-2 depot57-1-3 depot57-1-4 depot57-2-1 depot57-2-2 depot57-2-3 depot65-1-1 depot65-1-2 depot65-1-3 depot65-1-4 depot65-2-1 depot65-2-2 depot65-2-3 depot66-1-1 depot66-1-2 depot66-1-3 depot66-1-4 depot66-2-1 depot66-2-2 depot66-2-3 depot66-2-4 depot67-1-1 depot67-1-2 depot67-1-3 depot67-1-4 depot67-2-1 depot67-2-2 depot67-2-3 depot68-1-1 depot68-1-2 depot68-1-3 depot68-1-4 depot68-2-1 depot68-2-2 depot68-2-3 depot68-2-4 depot69-1-1 depot69-1-2 depot69-1-3 depot69-2-1 depot69-2-2 depot69-2-3 depot69-3-1 depot69-3-2 depot69-3-3 container-0-0 container-0-1 container-0-2 container-0-3 container-1-0 container-1-1 container-1-2 container-1-3 container-2-0 container-2-1 container-2-2 container-2-3 container-3-0 container-3-1 container-3-2 container-3-3 container-4-0 container-4-1 container-4-2 container-4-3 - storearea
	...
	depot48 depot49 depot50 depot51 depot52 depot53 depot54 depot55 depot56 depot57 depot65 depot66 depot67 depot68 depot69 - depot
...
(:init
	...
	(connected depot69-2-1 depot69-3-1)
	(connected depot69-2-1 depot69-2-2)
	(connected depot69-2-2 depot69-1-2)
	(connected depot69-2-2 depot69-3-2)
	(connected depot69-2-2 depot69-2-3)
	(connected depot69-2-2 depot69-2-1)
	(connected depot69-2-3 depot69-1-3)
	(connected depot69-2-3 depot69-3-3)
	(connected depot69-2-3 depot69-2-2)
	(connected depot69-3-1 depot69-2-1)
	(connected depot69-3-1 depot69-3-2)
	(connected depot69-3-2 depot69-2-2)
	(connected depot69-3-2 depot69-3-3)
	(connected depot69-3-2 depot69-3-1)
	(connected depot69-3-3 depot69-2-3)
	(connected depot69-3-3 depot69-3-2)
	...
	(in depot69-3-1 depot69)
	(in depot69-3-2 depot69)
	(in depot69-3-3 depot69)
	...
	(connected depot57-2-3 loadarea)
	(connected loadarea depot57-2-3)
	(connected depot65-2-3 loadarea)
	(connected loadarea depot65-2-3)
	(connected depot66-2-2 loadarea)
	(connected loadarea depot66-2-2)
	(connected depot67-2-1 loadarea)
	(connected loadarea depot67-2-1)
	(connected depot68-2-2 loadarea)
	(connected loadarea depot68-2-2)
	(connected depot69-3-3 loadarea)
	(connected loadarea depot69-3-3)  
	(clear depot48-1-1)
	(clear depot48-1-2)
	(clear depot48-1-3)
	(clear depot48-1-4)
	...
	(available hoist0)
	(at hoist1 depot49-2-4)
	(available hoist1)
	(at hoist2 depot50-1-4)
	(available hoist2)
	...
	(available hoist7)
	(at hoist8 depot51-1-3)
	(available hoist8)
	(at hoist9 depot51-1-4)
	(available hoist9)
	(at hoist10 depot51-2-2)
	(available hoist10)
	(at hoist11 depot52-2-1)
	(available hoist11)
	(at hoist12 depot52-1-4)
	(available hoist12)
	(at hoist13 depot52-1-1)
	(available hoist13)
	(at hoist14 depot53-2-1)
	(available hoist14)
	(at hoist15 depot54-2-1)
	(available hoist15)
	(at hoist16 depot55-2-1)
	(available hoist16)
	(at hoist17 depot55-1-3)
	(available hoist17)
	(at hoist18 depot55-1-2)
	(available hoist18)
	(at hoist19 depot56-1-1)
	(available hoist19)
	(at hoist20 depot56-2-1)
	(available hoist20)
	(at hoist21 depot56-1-4)
	(available hoist21)
	(at hoist22 depot56-1-2)
	(available hoist22)
	(at hoist23 depot65-1-2)
	(available hoist23)
	(at hoist24 depot65-2-3)
	(available hoist24)
	(at hoist25 depot65-1-4)
	(available hoist25)
	(at hoist26 depot66-2-3)
	(available hoist26)
	(at hoist27 depot66-1-2)
	(available hoist27)
	(at hoist28 depot66-1-1)
	(available hoist28)
	(at hoist29 depot66-2-2)
	(available hoist29)
	(at hoist30 depot67-2-3)
	(available hoist30)
	(at hoist31 depot67-2-1)
	(available hoist31)
	(at hoist32 depot67-2-2)
	(available hoist32)
	(at hoist33 depot68-2-3)
	(available hoist33)
	(at hoist34 depot69-3-2)
	(available hoist34)
	(at hoist35 depot69-1-1)
	(available hoist35)
	(at hoist36 depot69-1-3)
	(available hoist36))
