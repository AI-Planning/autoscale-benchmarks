...
;
; Map of the Depots:                                                                                                                                                             
; 0000 1111=2222 3333=4444=5555 6666=7777=8888=9999=AAAA BBBB CCCC DDDD EEEE FFFF GGGG=HHHH                                                                  
; *00  11*1 2*2  33 * *444 55 * *666 7*7  88*8 *99  AA*A BB*  C*C  DD*D *EEE F*F  GG*  HHHH                                                                  
;                                                                                      H*H                                                                   
;------------------------------------------------------------------------------------------                                                                  
; 48: depot48 area
; 49: depot49 area
...
(:objects
	depot48-1-1 depot48-1-2 depot48-1-3 depot48-1-4 depot48-2-1 depot48-2-2 depot48-2-3 depot49-1-1 depot49-1-2 depot49-1-3 depot49-1-4 depot49-2-1 depot49-2-2 depot49-2-3 depot49-2-4 depot50-1-1 depot50-1-2 depot50-1-3 depot50-1-4 depot50-2-1 depot50-2-2 depot50-2-3 depot51-1-1 depot51-1-2 depot51-1-3 depot51-1-4 depot51-2-1 depot51-2-2 depot51-2-4 depot52-1-1 depot52-1-2 depot52-1-3 depot52-1-4 depot52-2-1 depot52-2-2 depot52-2-3 depot52-2-4 depot53-1-1 depot53-1-2 depot53-1-3 depot53-1-4 depot53-2-1 depot53-2-2 depot53-2-4 depot54-1-1 depot54-1-2 depot54-1-3 depot54-1-4 depot54-2-1 depot54-2-2 depot54-2-3 depot54-2-4 depot55-1-1 depot55-1-2 depot55-1-3 depot55-1-4 depot55-2-1 depot55-2-2 depot55-2-3 depot56-1-1 depot56-1-2 depot56-1-3 depot56-1-4 depot56-2-1 depot56-2-2 depot56-2-3 depot56-2-4 depot57-1-1 depot57-1-2 depot57-1-3 depot57-1-4 depot57-2-1 depot57-2-2 depot57-2-3 depot65-1-1 depot65-1-2 depot65-1-3 depot65-1-4 depot65-2-1 depot65-2-2 depot65-2-3 depot65-2-4 depot66-1-1 depot66-1-2 depot66-1-3 depot66-1-4 depot66-2-1 depot66-2-2 depot66-2-3 depot67-1-1 depot67-1-2 depot67-1-3 depot67-1-4 depot67-2-1 depot67-2-2 depot67-2-3 depot68-1-1 depot68-1-2 depot68-1-3 depot68-1-4 depot68-2-1 depot68-2-2 depot68-2-3 depot68-2-4 depot69-1-1 depot69-1-2 depot69-1-3 depot69-1-4 depot69-2-1 depot69-2-2 depot69-2-3 depot69-2-4 depot70-1-1 depot70-1-2 depot70-1-3 depot70-1-4 depot70-2-1 depot70-2-2 depot70-2-3 depot71-1-1 depot71-1-2 depot71-1-3 depot71-1-4 depot71-2-1 depot71-2-2 depot71-2-3 depot72-1-1 depot72-1-2 depot72-1-3 depot72-1-4 depot72-2-1 depot72-2-2 depot72-2-3 depot72-2-4 depot72-3-1 depot72-3-2 depot72-3-3 container-0-0 container-0-1 container-0-2 container-0-3 container-1-0 container-1-1 container-1-2 container-1-3 container-2-0 container-2-1 container-2-2 container-2-3 container-3-0 container-3-1 container-3-2 container-3-3 container-4-0 container-4-1 container-4-2 container-4-3 container-5-0 container-5-1 container-5-2 container-5-3 - storearea
	...
	depot48 depot49 depot50 depot51 depot52 depot53 depot54 depot55 depot56 depot57 depot65 depot66 depot67 depot68 depot69 depot70 depot71 depot72 - depot
	loadarea transit0 transit1 transit2 transit3 transit4 transit5 transit6 transit7 - transitarea)
...
(:init
	...
	(connected depot54-2-3 depot54-2-4)
	(connected depot54-2-3 depot54-2-2)
	(connected depot54-2-4 depot54-1-4)
	(connected depot54-2-4 depot54-2-3)
	...
	(connected depot72-3-1 depot72-2-1)
	(connected depot72-3-1 depot72-3-2)
	(connected depot72-3-2 depot72-2-2)
	(connected depot72-3-2 depot72-3-3)
	(connected depot72-3-2 depot72-3-1)
	(connected depot72-3-3 depot72-2-3)
	(connected depot72-3-3 depot72-3-2)
	(connected transit0 depot49-1-4)
	(connected transit0 depot50-1-1)
	(connected transit1 depot51-1-4)
	(connected transit1 depot52-1-1)
	(connected transit2 depot52-1-4)
	(connected transit2 depot53-1-1)
	(connected transit3 depot54-1-4)
	(connected transit3 depot55-1-1)
	(connected transit4 depot55-1-4)
	(connected transit4 depot56-1-1)
	(connected transit5 depot56-1-4)
	(connected transit5 depot57-1-1)
	(connected transit6 depot57-1-4)
	(connected transit6 depot65-1-1)
	(connected transit7 depot71-1-4)
	...
	(in depot72-3-1 depot72)
	(in depot72-3-2 depot72)
	(in depot72-3-3 depot72)
	...
	(connected depot51-2-4 loadarea)
	(connected loadarea depot51-2-4)
	...
	(connected depot56-2-3 loadarea)
	(connected loadarea depot56-2-3)
	...
	(connected depot67-2-2 loadarea)
	(connected loadarea depot67-2-2)
	...
	(connected depot71-2-3 loadarea)
	(connected loadarea depot71-2-3)
	(connected depot72-3-2 loadarea)
	(connected loadarea depot72-3-2)  
	(clear depot48-2-2)
	(clear depot48-1-2)
	(clear depot48-1-3)
	(clear depot48-1-4)
	...
	(available hoist2)
	(at hoist3 depot50-2-2)
	(available hoist3)
	(at hoist4 depot50-1-4)
	(available hoist4)
	(at hoist5 depot51-1-3)
	(available hoist5)
	(at hoist6 depot52-1-2)
	(available hoist6)
	(at hoist7 depot52-2-4)
	(available hoist7)
	(at hoist8 depot52-1-1)
	(available hoist8)
	(at hoist9 depot52-1-4)
	(available hoist9)
	(at hoist10 depot52-2-3)
	(available hoist10)
	...
	(available hoist13)
	(at hoist14 depot54-1-4)
	(available hoist14)
	(at hoist15 depot54-1-2)
	(available hoist15)
	(at hoist16 depot54-1-1)
	(available hoist16)
	(at hoist17 depot54-1-3)
	(available hoist17)
	(at hoist18 depot55-1-4)
	(available hoist18)
	(at hoist19 depot55-2-3)
	(available hoist19)
	(at hoist20 depot57-2-3)
	(available hoist20)
	(at hoist21 depot57-2-1)
	(available hoist21)
	(at hoist22 depot65-2-2)
	(available hoist22)
	(at hoist23 depot65-1-2)
	(available hoist23)
	(at hoist24 depot65-1-3)
	(available hoist24)
	(at hoist25 depot66-2-3)
	(available hoist25)
	(at hoist26 depot66-1-4)
	(available hoist26)
	(at hoist27 depot67-1-2)
	(available hoist27)
	(at hoist28 depot67-1-4)
	(available hoist28)
	(at hoist29 depot68-2-1)
	(available hoist29)
	(at hoist30 depot68-1-3)
	(available hoist30)
	(at hoist31 depot69-2-2)
	(available hoist31)
	(at hoist32 depot69-2-4)
	(available hoist32)
	(at hoist33 depot69-1-2)
	(available hoist33)
	(at hoist34 depot69-1-3)
	(available hoist34)
	(at hoist35 depot69-2-1)
	(available hoist35)
	(at hoist36 depot69-1-1)
	(available hoist36)
	(at hoist37 depot70-1-3)
	(available hoist37)
	(at hoist38 depot70-1-4)
	(available hoist38)
	(at hoist39 depot70-1-1)
	(available hoist39)
	(at hoist40 depot71-1-4)
	(available hoist40)
	(at hoist41 depot72-1-2)
	(available hoist41)
	(at hoist42 depot72-3-3)
	(available hoist42)
	(at hoist43 depot72-2-1)
	(available hoist43))
