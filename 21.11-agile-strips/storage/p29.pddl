...
(:objects
	depot48-1-1 depot48-1-2 depot48-1-3 depot48-1-4 depot48-2-1 depot48-2-2 depot48-2-3 depot48-2-4 depot48-3-1 depot48-3-3 depot49-1-1 depot49-1-2 depot49-1-3 depot49-2-1 depot49-2-2 depot49-2-3 depot49-3-1 depot49-3-2 depot49-3-3 depot50-1-1 depot50-1-2 depot50-1-3 depot50-2-1 depot50-2-2 depot50-2-3 depot50-3-1 depot50-3-2 depot50-3-3 depot51-1-1 depot51-1-2 depot51-1-3 depot51-2-1 depot51-2-2 depot51-2-3 depot51-3-1 depot51-3-2 depot51-3-3 container-0-0 container-0-1 container-0-2 container-0-3 container-1-0 container-1-1 container-1-2 container-1-3 container-2-0 container-2-1 container-2-2 container-2-3 container-3-0 container-3-1 container-3-2 container-3-3 container-4-0 - storearea
...
(:init
	...
	(connected depot49-3-1 loadarea)
	(connected loadarea depot49-3-1)
	(connected depot50-3-3 loadarea)
	(connected loadarea depot50-3-3)
	(connected depot51-3-3 loadarea)
	(connected loadarea depot51-3-3)  
	(clear depot48-3-3)
	(clear depot48-2-4)
	(clear depot50-3-2)
	(clear depot50-2-3)
	...
	(available hoist3)
	(at hoist4 depot48-3-1)
	(available hoist4)
	(at hoist5 depot48-1-2)
	(available hoist5)
	(at hoist6 depot48-2-1)
	(available hoist6)
	(at hoist7 depot48-1-1)
	(available hoist7)
	(at hoist8 depot49-3-3)
	(available hoist8)
	(at hoist9 depot49-3-2)
	(available hoist9)
	(at hoist10 depot49-2-3)
	(available hoist10)
	(at hoist11 depot49-1-3)
	(available hoist11)
	(at hoist12 depot49-3-1)
	(available hoist12)
	(at hoist13 depot49-1-1)
	(available hoist13)
	(at hoist14 depot49-2-1)
	(available hoist14)
	(at hoist15 depot49-2-2)
	(available hoist15)
	(at hoist16 depot49-1-2)
	(available hoist16)
	(at hoist17 depot50-3-3)
	(available hoist17)
	(at hoist18 depot50-3-1)
	(available hoist18)
	(at hoist19 depot50-1-1)
	(available hoist19)
	(at hoist20 depot50-1-2)
	(available hoist20)
	(at hoist21 depot51-3-1)
	(available hoist21)
	(at hoist22 depot51-2-2)
	(available hoist22)
	(at hoist23 depot51-2-3)
	(available hoist23)
