...
(:init
	...
	(connected transit4 depot54-1-4)
	(connected transit4 depot55-1-1)
	...
	(available hoist4)
	(at hoist5 depot49-1-4)
	(available hoist5)
	(at hoist6 depot50-1-3)
	(available hoist6)
	(at hoist7 depot50-1-1)
	(available hoist7)
	...
	(available hoist15)
	(at hoist16 depot54-1-4)
	(available hoist16)
	(at hoist17 depot54-2-2)
	(available hoist17)
	(at hoist18 depot54-1-3)
	(available hoist18)
	(at hoist19 depot55-1-4)
	(available hoist19)
	(at hoist20 depot56-1-4)
	(available hoist20))
