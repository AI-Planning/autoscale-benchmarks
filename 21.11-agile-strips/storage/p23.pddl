...
;
; Map of the Depots:                                                                                                                                                                           
; 0000=1111=2222 3333=4444=5555=6666 7777=8888 9999=AAAA BBBB CCCC DDDD=EEEE FFFF=GGGG HHHH=IIII=JJJJ                                                                      
; 00*0 11*  *222 33*  44*  555* 66 * *77  *888 99 * AA*A BB*  CC*C D*D  EE * *FF  G*GG *HH  I*II JJ*J                                                                      
;----------------------------------------------------------------------------------------------------                                                                      
; 48: depot48 area
; 49: depot49 area
; 50: depot50 area
...
(:objects
	depot48-1-1 depot48-1-2 depot48-1-3 depot48-1-4 depot48-2-1 depot48-2-2 depot48-2-3 depot48-2-4 depot49-1-1 depot49-1-2 depot49-1-3 depot49-1-4 depot49-2-1 depot49-2-2 depot49-2-3 depot50-1-1 depot50-1-2 depot50-1-3 depot50-1-4 depot50-2-1 depot50-2-2 depot50-2-3 depot50-2-4 depot51-1-1 depot51-1-2 depot51-1-3 depot51-1-4 depot51-2-1 depot51-2-2 depot51-2-3 depot52-1-1 depot52-1-2 depot52-1-3 depot52-1-4 depot52-2-1 depot52-2-2 depot52-2-3 depot53-1-1 depot53-1-2 depot53-1-3 depot53-1-4 depot53-2-1 depot53-2-2 depot53-2-3 depot53-2-4 depot54-1-1 depot54-1-2 depot54-1-3 depot54-1-4 depot54-2-1 depot54-2-2 depot54-2-4 depot55-1-1 depot55-1-2 depot55-1-3 depot55-1-4 depot55-2-1 depot55-2-2 depot55-2-3 depot56-1-1 depot56-1-2 depot56-1-3 depot56-1-4 depot56-2-1 depot56-2-2 depot56-2-3 depot56-2-4 depot57-1-1 depot57-1-2 depot57-1-3 depot57-1-4 depot57-2-1 depot57-2-2 depot57-2-4 depot65-1-1 depot65-1-2 depot65-1-3 depot65-1-4 depot65-2-1 depot65-2-2 depot65-2-3 depot65-2-4 depot66-1-1 depot66-1-2 depot66-1-3 depot66-1-4 depot66-2-1 depot66-2-2 depot66-2-3 depot67-1-1 depot67-1-2 depot67-1-3 depot67-1-4 depot67-2-1 depot67-2-2 depot67-2-3 depot67-2-4 depot68-1-1 depot68-1-2 depot68-1-3 depot68-1-4 depot68-2-1 depot68-2-2 depot68-2-3 depot69-1-1 depot69-1-2 depot69-1-3 depot69-1-4 depot69-2-1 depot69-2-2 depot69-2-4 depot70-1-1 depot70-1-2 depot70-1-3 depot70-1-4 depot70-2-1 depot70-2-2 depot70-2-3 depot71-1-1 depot71-1-2 depot71-1-3 depot71-1-4 depot71-2-1 depot71-2-2 depot71-2-3 depot71-2-4 depot72-1-1 depot72-1-2 depot72-1-3 depot72-1-4 depot72-2-1 depot72-2-2 depot72-2-3 depot73-1-1 depot73-1-2 depot73-1-3 depot73-1-4 depot73-2-1 depot73-2-2 depot73-2-3 depot73-2-4 depot74-1-1 depot74-1-2 depot74-1-3 depot74-1-4 depot74-2-1 depot74-2-2 depot74-2-3 depot74-2-4 container-0-0 container-0-1 container-0-2 container-0-3 container-1-0 container-1-1 container-1-2 container-1-3 container-2-0 container-2-1 container-2-2 container-2-3 container-3-0 container-3-1 container-3-2 container-3-3 container-4-0 container-4-1 container-4-2 container-4-3 container-5-0 container-5-1 container-5-2 container-5-3 container-6-0 container-6-1 - storearea
	...
	depot48 depot49 depot50 depot51 depot52 depot53 depot54 depot55 depot56 depot57 depot65 depot66 depot67 depot68 depot69 depot70 depot71 depot72 depot73 depot74 - depot
...
(:init
	...
	(connected depot54-1-4 depot54-2-4)
	...
	(connected depot54-2-4 depot54-1-4)
	...
	(connected depot73-2-3 depot73-2-4)
	(connected depot73-2-3 depot73-2-2)
	(connected depot73-2-4 depot73-1-4)
	(connected depot73-2-4 depot73-2-3)
	...
	(connected depot74-1-4 depot74-2-4)
	...
	(connected depot74-2-3 depot74-2-4)
	(connected depot74-2-3 depot74-2-2)
	(connected depot74-2-4 depot74-1-4)
	(connected depot74-2-4 depot74-2-3)
	...
	(connected transit3 depot52-1-4)
	(connected transit3 depot53-1-1)
	(connected transit4 depot53-1-4)
	(connected transit4 depot54-1-1)
	(connected transit5 depot55-1-4)
	(connected transit5 depot56-1-1)
	(connected transit6 depot57-1-4)
	(connected transit6 depot65-1-1)
	(connected transit7 depot68-1-4)
	(connected transit7 depot69-1-1)
	(connected transit8 depot70-1-4)
	(connected transit8 depot71-1-1)
	(connected transit9 depot72-1-4)
	(connected transit9 depot73-1-1)
	(connected transit10 depot73-1-4)
	(connected transit10 depot74-1-1)
	...
	(connected depot54-2-4 loadarea)
	(connected loadarea depot54-2-4)
	(connected depot55-2-1 loadarea)
	(connected loadarea depot55-2-1)
	(connected depot56-2-1 loadarea)
	(connected loadarea depot56-2-1)
	(connected depot57-2-4 loadarea)
	(connected loadarea depot57-2-4)
	(connected depot65-2-3 loadarea)
	(connected loadarea depot65-2-3)
	(connected depot66-2-3 loadarea)
	(connected loadarea depot66-2-3)
	(connected depot67-2-3 loadarea)
	(connected loadarea depot67-2-3)
	(connected depot68-2-2 loadarea)
	(connected loadarea depot68-2-2)
	(connected depot69-2-4 loadarea)
	(connected loadarea depot69-2-4)
	(connected depot70-2-1 loadarea)
	(connected loadarea depot70-2-1)
	(connected depot71-2-2 loadarea)
	(connected loadarea depot71-2-2)
	(connected depot72-2-1 loadarea)
	(connected loadarea depot72-2-1)
	(connected depot73-2-2 loadarea)
	(connected loadarea depot73-2-2)
	(connected depot74-2-3 loadarea)
	(connected loadarea depot74-2-3)  
	(clear depot48-1-1)
	(clear depot48-1-2)
	(clear depot48-1-3)
	(clear depot48-1-4)
	...
	(available hoist1)
	(at hoist2 depot50-2-4)
	(available hoist2)
	(at hoist3 depot50-2-3)
	(available hoist3)
	(at hoist4 depot51-2-1)
	(available hoist4)
	(at hoist5 depot51-1-2)
	(available hoist5)
	(at hoist6 depot51-1-1)
	(available hoist6)
	(at hoist7 depot51-1-3)
	(available hoist7)
	(at hoist8 depot52-1-3)
	(available hoist8)
	(at hoist9 depot52-2-2)
	(available hoist9)
	(at hoist10 depot52-1-2)
	(available hoist10)
	(at hoist11 depot53-1-1)
	(available hoist11)
	(at hoist12 depot53-1-3)
	(available hoist12)
	(at hoist13 depot53-2-4)
	(available hoist13)
	(at hoist14 depot54-1-1)
	(available hoist14)
	(at hoist15 depot54-1-4)
	(available hoist15)
	(at hoist16 depot55-1-1)
	(available hoist16)
	(at hoist17 depot55-1-2)
	(available hoist17)
	(at hoist18 depot56-2-2)
	(available hoist18)
	(at hoist19 depot56-2-1)
	(available hoist19)
	(at hoist20 depot57-1-2)
	(available hoist20)
	(at hoist21 depot57-2-2)
	(available hoist21)
	(at hoist22 depot57-2-1)
	(available hoist22)
	(at hoist23 depot57-2-4)
	(available hoist23)
	(at hoist24 depot57-1-4)
	(available hoist24)
	(at hoist25 depot65-1-1)
	(available hoist25)
	(at hoist26 depot65-2-1)
	(available hoist26)
	(at hoist27 depot65-2-2)
	(available hoist27)
	(at hoist28 depot65-2-3)
	(available hoist28)
	(at hoist29 depot66-1-3)
	(available hoist29)
	(at hoist30 depot66-1-2)
	(available hoist30)
	(at hoist31 depot66-1-1)
	(available hoist31)
	(at hoist32 depot66-1-4)
	(available hoist32)
	(at hoist33 depot67-1-1)
	(available hoist33)
	(at hoist34 depot67-1-2)
	(available hoist34)
	(at hoist35 depot67-2-1)
	(available hoist35)
	(at hoist36 depot68-1-3)
	(available hoist36)
	(at hoist37 depot68-2-2)
	(available hoist37)
	(at hoist38 depot68-1-2)
	(available hoist38)
	(at hoist39 depot69-2-2)
	(available hoist39)
	(at hoist40 depot69-1-1)
	(available hoist40)
	(at hoist41 depot70-1-1)
	(available hoist41)
	(at hoist42 depot71-1-2)
	(available hoist42)
	(at hoist43 depot71-2-3)
	(available hoist43)
	(at hoist44 depot73-2-4)
	(available hoist44)
	(at hoist45 depot73-1-3)
	(available hoist45)
	(at hoist46 depot73-1-4)
	(available hoist46)
	(at hoist47 depot74-2-3)
	(available hoist47))
