(define (problem name)
 ...
 (:objects tile_0-1 tile_0-2 tile_0-3 tile_0-4 tile_0-5 tile_0-6 tile_0-7 
           ...
           tile_9-1 tile_9-2 tile_9-3 tile_9-4 tile_9-5 tile_9-6 tile_9-7 - tile
           robot1 robot2 robot3 robot4 - robot
           white black - color
)
 (:init 
   (= (total-cost) 0)
   (robot-at robot1 tile_6-6)
   (robot-has robot1 white)
   (robot-at robot2 tile_7-4)
   (robot-has robot2 black)
   (robot-at robot3 tile_5-7)
   (robot-has robot3 white)
   (robot-at robot4 tile_9-3)
