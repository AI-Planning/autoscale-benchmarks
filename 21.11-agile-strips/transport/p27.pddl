; Transport city-sequential-47nodes-1000size-3degree-100mindistance-83trucks-86packages-2045seed

(define (problem transport-city-sequential-47nodes-1000size-3degree-100mindistance-83trucks-86packages-2045seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:init
  ...
  (= (road-length city-loc-10 city-loc-1) 16)
  ; 80,585 -> 7,725
  (road city-loc-1 city-loc-10)
  (= (road-length city-loc-1 city-loc-10) 16)
  ; 744,243 -> 798,119
  ...
  (= (road-length city-loc-13 city-loc-11) 14)
  ; 744,243 -> 616,292
  (road city-loc-11 city-loc-13)
  (= (road-length city-loc-11 city-loc-13) 14)
  ; 422,642 -> 532,684
  ...
  (= (road-length city-loc-17 city-loc-12) 16)
  ; 662,991 -> 510,975
  (road city-loc-12 city-loc-17)
  (= (road-length city-loc-12 city-loc-17) 16)
  ; 449,309 -> 382,235
  (road city-loc-18 city-loc-3)
  (= (road-length city-loc-18 city-loc-3) 10)
  ; 382,235 -> 449,309
  (road city-loc-3 city-loc-18)
  (= (road-length city-loc-3 city-loc-18) 10)
  ; 449,309 -> 616,292
  ...
  (= (road-length city-loc-19 city-loc-9) 15)
  ; 267,995 -> 390,921
  (road city-loc-9 city-loc-19)
  (= (road-length city-loc-9 city-loc-19) 15)
  ; 390,921 -> 510,975
  ...
  (= (road-length city-loc-20 city-loc-8) 16)
  ; 213,869 -> 254,714
  (road city-loc-8 city-loc-20)
  (= (road-length city-loc-8 city-loc-20) 16)
  ; 38,440 -> 80,585
  ...
  (= (road-length city-loc-24 city-loc-13) 16)
  ; 616,292 -> 607,134
  (road city-loc-13 city-loc-24)
  (= (road-length city-loc-13 city-loc-24) 16)
  ; 874,604 -> 762,677
  ...
  (= (road-length city-loc-27 city-loc-24) 14)
  ; 607,134 -> 473,140
  (road city-loc-24 city-loc-27)
  (= (road-length city-loc-24 city-loc-27) 14)
  ; 861,279 -> 798,119
  ...
  (= (road-length city-loc-28 city-loc-11) 13)
  ; 744,243 -> 861,279
  (road city-loc-11 city-loc-28)
  (= (road-length city-loc-11 city-loc-28) 13)
  ; 861,279 -> 915,167
  ...
  (= (road-length city-loc-29 city-loc-16) 11)
  ; 990,472 -> 881,489
  (road city-loc-16 city-loc-29)
  (= (road-length city-loc-16 city-loc-29) 11)
  ; 881,489 -> 874,604
  (road city-loc-29 city-loc-25)
  (= (road-length city-loc-29 city-loc-25) 12)
  ; 874,604 -> 881,489
  (road city-loc-25 city-loc-29)
  (= (road-length city-loc-25 city-loc-29) 12)
  ; 516,819 -> 532,684
  ...
  (= (road-length city-loc-32 city-loc-23) 12)
  ; 887,799 -> 983,871
  (road city-loc-23 city-loc-32)
  (= (road-length city-loc-23 city-loc-32) 12)
  ; 350,76 -> 382,235
  ...
  (= (road-length city-loc-33 city-loc-27) 14)
  ; 473,140 -> 350,76
  (road city-loc-27 city-loc-33)
  (= (road-length city-loc-27 city-loc-33) 14)
  ; 270,199 -> 382,235
  (road city-loc-34 city-loc-3)
  (= (road-length city-loc-34 city-loc-3) 12)
  ; 382,235 -> 270,199
  (road city-loc-3 city-loc-34)
  (= (road-length city-loc-3 city-loc-34) 12)
  ; 270,199 -> 350,76
  ...
  (= (road-length city-loc-35 city-loc-14) 13)
  ; 422,642 -> 355,744
  (road city-loc-14 city-loc-35)
  (= (road-length city-loc-14 city-loc-35) 13)
  ; 355,744 -> 254,714
  (road city-loc-35 city-loc-20)
  (= (road-length city-loc-35 city-loc-20) 11)
  ; 254,714 -> 355,744
  (road city-loc-20 city-loc-35)
  (= (road-length city-loc-20 city-loc-35) 11)
  ; 748,463 -> 881,489
  (road city-loc-36 city-loc-29)
  (= (road-length city-loc-36 city-loc-29) 14)
  ; 881,489 -> 748,463
  (road city-loc-29 city-loc-36)
  (= (road-length city-loc-29 city-loc-36) 14)
  ; 657,627 -> 532,684
  ...
  (= (road-length city-loc-37 city-loc-5) 12)
  ; 762,677 -> 657,627
  (road city-loc-5 city-loc-37)
  (= (road-length city-loc-5 city-loc-37) 12)
  ; 129,969 -> 213,869
  (road city-loc-38 city-loc-8)
  (= (road-length city-loc-38 city-loc-8) 14)
  ; 213,869 -> 129,969
  (road city-loc-8 city-loc-38)
  (= (road-length city-loc-8 city-loc-38) 14)
  ; 129,969 -> 267,995
  ...
  (= (road-length city-loc-39 city-loc-25) 11)
  ; 874,604 -> 774,568
  (road city-loc-25 city-loc-39)
  (= (road-length city-loc-25 city-loc-39) 11)
  ; 774,568 -> 881,489
  ...
  (= (road-length city-loc-39 city-loc-36) 11)
  ; 748,463 -> 774,568
  (road city-loc-36 city-loc-39)
  (= (road-length city-loc-36 city-loc-39) 11)
  ; 774,568 -> 657,627
  (road city-loc-39 city-loc-37)
  (= (road-length city-loc-39 city-loc-37) 14)
  ; 657,627 -> 774,568
  (road city-loc-37 city-loc-39)
  (= (road-length city-loc-37 city-loc-39) 14)
  ; 939,381 -> 990,472
  ...
  (= (road-length city-loc-41 city-loc-28) 13)
  ; 861,279 -> 939,381
  (road city-loc-28 city-loc-41)
  (= (road-length city-loc-28 city-loc-41) 13)
  ; 939,381 -> 881,489
  ...
  (= (road-length city-loc-42 city-loc-13) 11)
  ; 616,292 -> 602,396
  (road city-loc-13 city-loc-42)
  (= (road-length city-loc-13 city-loc-42) 11)
  ; 602,396 -> 748,463
  (road city-loc-42 city-loc-36)
  (= (road-length city-loc-42 city-loc-36) 17)
  ; 748,463 -> 602,396
  (road city-loc-36 city-loc-42)
  (= (road-length city-loc-36 city-loc-42) 17)
  ; 135,288 -> 270,199
  (road city-loc-43 city-loc-34)
  (= (road-length city-loc-43 city-loc-34) 17)
  ; 270,199 -> 135,288
  (road city-loc-34 city-loc-43)
  (= (road-length city-loc-34 city-loc-43) 17)
  ; 135,288 -> 61,189
  (road city-loc-43 city-loc-40)
  (= (road-length city-loc-43 city-loc-40) 13)
  ; 61,189 -> 135,288
  (road city-loc-40 city-loc-43)
  (= (road-length city-loc-40 city-loc-43) 13)
  ; 532,224 -> 382,235
  ...
  (= (road-length city-loc-44 city-loc-24) 12)
  ; 607,134 -> 532,224
  (road city-loc-24 city-loc-44)
  (= (road-length city-loc-24 city-loc-44) 12)
  ; 532,224 -> 473,140
  (road city-loc-44 city-loc-27)
  (= (road-length city-loc-44 city-loc-27) 11)
  ; 473,140 -> 532,224
  (road city-loc-27 city-loc-44)
  (= (road-length city-loc-27 city-loc-44) 11)
  ; 490,528 -> 532,684
  (road city-loc-45 city-loc-4)
  (= (road-length city-loc-45 city-loc-4) 17)
  ; 532,684 -> 490,528
  (road city-loc-4 city-loc-45)
  (= (road-length city-loc-4 city-loc-45) 17)
  ; 490,528 -> 422,642
  (road city-loc-45 city-loc-14)
  (= (road-length city-loc-45 city-loc-14) 14)
  ; 422,642 -> 490,528
  (road city-loc-14 city-loc-45)
  (= (road-length city-loc-14 city-loc-45) 14)
  ; 490,528 -> 602,396
  ...
  (= (road-length city-loc-46 city-loc-1) 11)
  ; 80,585 -> 135,494
  (road city-loc-1 city-loc-46)
  (= (road-length city-loc-1 city-loc-46) 11)
  ; 135,494 -> 304,495
  (road city-loc-46 city-loc-6)
  (= (road-length city-loc-46 city-loc-6) 17)
  ; 304,495 -> 135,494
  (road city-loc-6 city-loc-46)
  (= (road-length city-loc-6 city-loc-46) 17)
  ; 135,494 -> 38,440
  ...
  (= (road-length city-loc-47 city-loc-28) 14)
  ; 861,279 -> 745,351
  (road city-loc-28 city-loc-47)
  (= (road-length city-loc-28 city-loc-47) 14)
  ; 745,351 -> 748,463
  ...
  (at package-30 city-loc-26)
  (at package-31 city-loc-14)
  (at package-32 city-loc-8)
  (at package-33 city-loc-22)
  (at package-34 city-loc-45)
  ...
  (at package-40 city-loc-20)
  (at package-41 city-loc-41)
  (at package-42 city-loc-1)
  (at package-43 city-loc-6)
  (at package-44 city-loc-11)
  (at package-45 city-loc-40)
  (at package-46 city-loc-34)
  (at package-47 city-loc-13)
  (at package-48 city-loc-10)
  (at package-49 city-loc-39)
  (at package-50 city-loc-45)
  (at package-51 city-loc-20)
  (at package-52 city-loc-42)
  (at package-53 city-loc-13)
  (at package-54 city-loc-2)
  (at package-55 city-loc-41)
  (at package-56 city-loc-34)
  (at package-57 city-loc-6)
  (at package-58 city-loc-46)
  (at package-59 city-loc-5)
  (at package-60 city-loc-38)
  (at package-61 city-loc-37)
  (at package-62 city-loc-22)
  (at package-63 city-loc-1)
  (at package-64 city-loc-35)
  (at package-65 city-loc-27)
  (at package-66 city-loc-45)
  (at package-67 city-loc-39)
  (at package-68 city-loc-19)
  (at package-69 city-loc-23)
  (at package-70 city-loc-18)
  (at package-71 city-loc-42)
  (at package-72 city-loc-34)
  (at package-73 city-loc-34)
  (at package-74 city-loc-39)
  (at package-75 city-loc-14)
  (at package-76 city-loc-39)
  (at package-77 city-loc-21)
  (at package-78 city-loc-47)
  (at package-79 city-loc-45)
  (at package-80 city-loc-24)
  (at package-81 city-loc-27)
  (at package-82 city-loc-16)
  (at package-83 city-loc-28)
  (at package-84 city-loc-41)
  (at package-85 city-loc-36)
  (at package-86 city-loc-45)
  ...
  (at truck-16 city-loc-43)
  (capacity truck-16 capacity-2)
  (at truck-17 city-loc-15)
  (capacity truck-17 capacity-3)
  (at truck-18 city-loc-31)
  ...
  (at truck-24 city-loc-28)
  (capacity truck-24 capacity-3)
  (at truck-25 city-loc-46)
  (capacity truck-25 capacity-4)
  (at truck-26 city-loc-25)
  ...
  (at truck-50 city-loc-41)
  (capacity truck-50 capacity-4)
  (at truck-51 city-loc-32)
  (capacity truck-51 capacity-3)
  (at truck-52 city-loc-47)
  ...
  (at truck-80 city-loc-24)
  (capacity truck-80 capacity-4)
  (at truck-81 city-loc-11)
  (capacity truck-81 capacity-4)
  (at truck-82 city-loc-20)
 ...
 (:goal (and
  ...
  (at package-40 city-loc-21)
  (at package-41 city-loc-46)
  (at package-42 city-loc-27)
  (at package-43 city-loc-34)
  (at package-44 city-loc-14)
  (at package-45 city-loc-21)
  (at package-46 city-loc-24)
  (at package-47 city-loc-42)
  (at package-48 city-loc-34)
  (at package-49 city-loc-37)
  (at package-50 city-loc-10)
  (at package-51 city-loc-13)
  (at package-52 city-loc-44)
  (at package-53 city-loc-33)
  (at package-54 city-loc-34)
  ...
  (at package-66 city-loc-44)
  (at package-67 city-loc-16)
  (at package-68 city-loc-41)
  (at package-69 city-loc-36)
  (at package-70 city-loc-37)
  (at package-71 city-loc-38)
  (at package-72 city-loc-42)
  (at package-73 city-loc-29)
  (at package-74 city-loc-35)
  (at package-75 city-loc-30)
  (at package-76 city-loc-42)
  (at package-77 city-loc-7)
  (at package-78 city-loc-45)
  (at package-79 city-loc-25)
  (at package-80 city-loc-26)
  (at package-81 city-loc-29)
  (at package-82 city-loc-12)
  (at package-83 city-loc-14)
  (at package-84 city-loc-28)
  (at package-85 city-loc-20)
  (at package-86 city-loc-12)
 ))
