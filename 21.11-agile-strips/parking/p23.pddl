(define   (problem parking)
  ...
  (:init
    ...
    (behind-car car_40 car_27)
    (car-clear car_40)
    (at-curb car_50)
    (at-curb-num car_50 curb_03)
    (behind-car car_51 car_50)
    (car-clear car_51)
    (at-curb car_16)
    ...
    (behind-car car_12 car_58)
    (car-clear car_12)
    (at-curb car_56)
    (at-curb-num car_56 curb_06)
    (behind-car car_22 car_56)
    (car-clear car_22)
    (at-curb car_54)
    (at-curb-num car_54 curb_07)
    (behind-car car_24 car_54)
    (car-clear car_24)
    (at-curb car_61)
    (at-curb-num car_61 curb_08)
    (behind-car car_35 car_61)
    (car-clear car_35)
    (at-curb car_08)
    (at-curb-num car_08 curb_09)
    (behind-car car_57 car_08)
    (car-clear car_57)
    (at-curb car_42)
    ...
    (behind-car car_60 car_14)
    (car-clear car_60)
    (at-curb car_67)
    (at-curb-num car_67 curb_12)
    (behind-car car_19 car_67)
    (car-clear car_19)
    (at-curb car_66)
    (at-curb-num car_66 curb_13)
    (behind-car car_48 car_66)
    (car-clear car_48)
    (at-curb car_03)
    (at-curb-num car_03 curb_14)
    (behind-car car_62 car_03)
    (car-clear car_62)
    (at-curb car_59)
    (at-curb-num car_59 curb_15)
    ...
    (car-clear car_47)
    (at-curb car_39)
    (at-curb-num car_39 curb_18)
    (behind-car car_06 car_39)
    (car-clear car_06)
    (at-curb car_18)
    (at-curb-num car_18 curb_19)
    (behind-car car_64 car_18)
    (car-clear car_64)
    (at-curb car_26)
    (at-curb-num car_26 curb_20)
    (behind-car car_52 car_26)
    (car-clear car_52)
    (at-curb car_53)
    (at-curb-num car_53 curb_21)
    (behind-car car_63 car_53)
    (car-clear car_63)
    (at-curb car_29)
    ...
    (car-clear car_13)
    (at-curb car_23)
    (at-curb-num car_23 curb_24)
    (behind-car car_44 car_23)
    (car-clear car_44)
    (at-curb car_09)
    ...
    (car-clear car_33)
    (at-curb car_41)
    (at-curb-num car_41 curb_26)
    (behind-car car_55 car_41)
    (car-clear car_55)
    (at-curb car_36)
    (at-curb-num car_36 curb_27)
    (behind-car car_45 car_36)
    (car-clear car_45)
    (at-curb car_37)
    (at-curb-num car_37 curb_28)
    (behind-car car_43 car_37)
    (car-clear car_43)
    (at-curb car_05)
    (at-curb-num car_05 curb_29)
    ...
    (car-clear car_31)
    (at-curb car_30)
    (at-curb-num car_30 curb_31)
    (behind-car car_32 car_30)
    (car-clear car_32)
    (at-curb car_38)
    (at-curb-num car_38 curb_32)
    (behind-car car_17 car_38)
    (car-clear car_17)
    (at-curb car_10)
    (at-curb-num car_10 curb_33)
...
; =========== INIT =========== 
;  curb_00: car_21 car_65 
;  curb_01: car_07 car_04 
;  curb_02: car_27 car_40 
;  curb_03: car_50 car_51 
;  curb_04: car_16 car_46 
;  curb_05: car_58 car_12 
;  curb_06: car_56 car_22 
;  curb_07: car_54 car_24 
;  curb_08: car_61 car_35 
;  curb_09: car_08 car_57 
;  curb_10: car_42 car_34 
;  curb_11: car_14 car_60 
;  curb_12: car_67 car_19 
;  curb_13: car_66 car_48 
;  curb_14: car_03 car_62 
;  curb_15: car_59 car_20 
;  curb_16: car_28 car_11 
;  curb_17: car_25 car_47 
;  curb_18: car_39 car_06 
;  curb_19: car_18 car_64 
;  curb_20: car_26 car_52 
;  curb_21: car_53 car_63 
;  curb_22: car_29 car_01 
;  curb_23: car_00 car_13 
;  curb_24: car_23 car_44 
;  curb_25: car_09 car_33 
;  curb_26: car_41 car_55 
;  curb_27: car_36 car_45 
;  curb_28: car_37 car_43 
;  curb_29: car_05 car_49 
;  curb_30: car_15 car_31 
;  curb_31: car_30 car_32 
;  curb_32: car_38 car_17 
;  curb_33: car_10 car_02 
;  curb_34: 
; ========== /INIT =========== 
