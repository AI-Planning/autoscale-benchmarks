(define   (problem parking)
  ...
  (:init
    ...
    (behind-car car_40 car_20)
    (car-clear car_40)
    (at-curb car_52)
    (at-curb-num car_52 curb_01)
    (behind-car car_05 car_52)
    (car-clear car_05)
    (at-curb car_15)
    ...
    (car-clear car_24)
    (at-curb car_41)
    (at-curb-num car_41 curb_11)
    (behind-car car_55 car_41)
    (car-clear car_55)
    (at-curb car_28)
    (at-curb-num car_28 curb_12)
    (behind-car car_36 car_28)
    (car-clear car_36)
    (at-curb car_50)
    (at-curb-num car_50 curb_13)
    ...
    (car-clear car_08)
    (at-curb car_26)
    (at-curb-num car_26 curb_18)
    (behind-car car_32 car_26)
    (car-clear car_32)
    (at-curb car_44)
    (at-curb-num car_44 curb_19)
    (behind-car car_54 car_44)
    (car-clear car_54)
    (at-curb car_30)
    ...
    (behind-car car_14 car_34)
    (car-clear car_14)
    (at-curb car_47)
    (at-curb-num car_47 curb_24)
    (behind-car car_22 car_47)
    (car-clear car_22)
    (at-curb car_17)
...
; =========== INIT =========== 
;  curb_00: car_20 car_40 
;  curb_01: car_52 car_05 
;  curb_02: car_15 car_04 
;  curb_03: car_31 car_29 
;  curb_04: car_01 car_18 
;  curb_05: car_53 car_38 
;  curb_06: car_46 car_25 
;  curb_07: car_42 car_51 
;  curb_08: car_48 car_21 
;  curb_09: car_06 car_23 
;  curb_10: car_07 car_24 
;  curb_11: car_41 car_55 
;  curb_12: car_28 car_36 
;  curb_13: car_50 car_49 
;  curb_14: car_16 car_27 
;  curb_15: car_19 car_12 
;  curb_16: car_33 car_09 
;  curb_17: car_02 car_08 
;  curb_18: car_26 car_32 
;  curb_19: car_44 car_54 
;  curb_20: car_30 car_35 
;  curb_21: car_13 car_43 
;  curb_22: car_10 car_00 
;  curb_23: car_34 car_14 
;  curb_24: car_47 car_22 
;  curb_25: car_17 car_11 
;  curb_26: car_45 car_03 
;  curb_27: car_37 car_39 
;  curb_28: 
; ========== /INIT =========== 
