;  14 x 14 with 1 robots, 1 carts, 3 tables, and 1  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-goal object0 x3 y4)
   (object-goal object1 x7 y5)
   (object-goal object1 x8 y11)
   (object-goal object2 x8 y4)
   (object-goal object2 x3 y6)
   ...
   (object-pos object0 x2 y8)
   (object-pos object1 x8 y9)
   (object-pos object2 x4 y10)
