;  9 x 9 with 1 robots, 1 carts, 2 tables, and 1  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-goal object0 x5 y6)
   (object-goal object1 x3 y3)
   (object-goal object1 x5 y6)
   (object-goal object2 x4 y2)
   (object-goal object2 x5 y6)
   ...
   (object-pos object1 x5 y6)
   (object-pos object2 x4 y3)
   (object-pos object3 x3 y2)
