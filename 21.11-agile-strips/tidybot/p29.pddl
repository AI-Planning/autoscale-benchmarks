;  15 x 15 with 1 robots, 1 carts, 2 tables, and 2  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-pos object0 x5 y4)
   (object-pos object1 x11 y7)
   (object-pos object2 x10 y2)
   (object-pos object3 x9 y8)
   (object-pos object4 x1 y10)
   (object-pos object5 x10 y3)
   (object-pos object6 x9 y6)
   (object-pos object7 x9 y3)
   (object-pos object8 x9 y7)
   (object-pos object9 x1 y9)
   (object-pos object10 x4 y3)
   (object-pos object11 x4 y4)
   (object-pos object12 x3 y9)
   (object-pos object13 x3 y8)
   (object-pos object14 x3 y2)
   (object-pos object15 x2 y8)
   (object-pos object16 x10 y7)
   (object-pos object17 x10 y8)
   ...
   (gripper-obstacle x10 y7)
   (gripper-obstacle x10 y8)
  ) 
