;  10 x 10 with 1 robots, 1 carts, 3 tables, and 1  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-goal object0 x2 y7)
   (object-goal object1 x2 y3)
   (object-goal object1 x6 y7)
   ...
   (object-pos object2 x2 y7)
   (object-pos object3 x6 y7)
   (object-pos object4 x2 y3)
   (object-pos object5 x7 y3)
   (object-pos object6 x4 y4)
   (object-pos object7 x3 y2)
   (object-pos object8 x1 y7)
