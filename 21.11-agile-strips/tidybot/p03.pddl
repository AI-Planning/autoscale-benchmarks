;  9 x 9 with 1 robots, 1 carts, 4 tables, and 1  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-goal object1 x6 y4)
   (object-goal object2 x3 y2)
   (object-goal object2 x6 y1)
   ...
   (base-obstacle x6 y4)(surface x6 y4)
   ...
   (object-pos object1 x3 y2)
   (object-pos object2 x4 y6)
   (object-pos object3 x2 y2)
