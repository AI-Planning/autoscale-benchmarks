;  14 x 14 with 1 robots, 1 carts, 4 tables, and 2  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-goal object0 x3 y9)
   (object-goal object1 x9 y7)
   (object-goal object1 x3 y11)
   (object-goal object2 x10 y6)
   (object-goal object3 x10 y7)
   (object-goal object4 x3 y2)
   (object-goal object5 x3 y3)
   (object-goal object5 x5 y7)
   (object-goal object6 x4 y2)
   (object-goal object6 x5 y9)
   (object-goal object7 x4 y3)
   (object-goal object7 x8 y2)
   ...
   (base-obstacle x11 y6)(gripper-obstacle x11 y6)
   (base-obstacle x11 y7)(gripper-obstacle x11 y7)
   ...
   (object-pos object0 x5 y7)
   (object-pos object1 x8 y3)
   (object-pos object2 x10 y6)
   (object-pos object3 x8 y10)
   (object-pos object4 x2 y7)
   (object-pos object5 x3 y2)
   (object-pos object6 x3 y7)
   (object-pos object7 x3 y9)
   
   (gripper-empty pr2)
   (gripper-rel pr2 xrel0 yrel0)
   (gripper-obstacle x5 y7)
