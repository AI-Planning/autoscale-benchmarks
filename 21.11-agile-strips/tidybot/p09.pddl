;  11 x 11 with 1 robots, 1 carts, 3 tables, and 1  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-goal object1 x5 y8)
   (object-goal object2 x6 y3)
   (object-goal object3 x6 y4)
   (object-goal object3 x1 y4)
   ...
   (object-pos object2 x5 y4)
   (object-pos object3 x5 y8)
