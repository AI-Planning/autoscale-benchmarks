;  11 x 11 with 1 robots, 1 carts, 4 tables, and 1  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-goal object0 x6 y8)
   (object-goal object1 x4 y4)
   (object-goal object2 x4 y5)
   (object-goal object2 x3 y8)
   ...
   (object-goal object6 x3 y8)
   (object-goal object7 x6 y4)
   (object-goal object7 x1 y1)
   ...
   (object-pos object3 x5 y4)
   (object-pos object4 x5 y5)
   (object-pos object5 x6 y3)
   (object-pos object6 x3 y8)
   (object-pos object7 x1 y7)
   (object-pos object8 x6 y8)
