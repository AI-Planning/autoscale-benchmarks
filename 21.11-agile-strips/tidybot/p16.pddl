;  12 x 12 with 1 robots, 1 carts, 5 tables, and 1  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-goal object0 x2 y5)
   (object-goal object1 x5 y4)
   (object-goal object1 x1 y1)
   (object-goal object2 x5 y5)
   (object-goal object3 x6 y3)
   (object-goal object3 x3 y9)
   (object-goal object4 x6 y4)
   (object-goal object4 x2 y8)
   (object-goal object5 x6 y5)
   (object-goal object5 x5 y8)
   (object-goal object6 x7 y3)
   (object-goal object6 x8 y8)
   (object-goal object7 x7 y4)
   (object-goal object7 x2 y9)
   (object-goal object8 x7 y5)
   (object-goal object8 x3 y8)
   ...
   (object-pos object0 x2 y3)
   (object-pos object1 x1 y9)
   (object-pos object2 x6 y4)
   (object-pos object3 x2 y1)
   (object-pos object4 x1 y8)
   (object-pos object5 x1 y1)
   (object-pos object6 x2 y8)
   (object-pos object7 x5 y3)
   (object-pos object8 x5 y8)
