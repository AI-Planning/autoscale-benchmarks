;  13 x 13 with 1 robots, 1 carts, 2 tables, and 1  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-goal object0 x9 y5)
   (object-goal object1 x3 y3)
   (object-goal object2 x3 y4)
   (object-goal object3 x4 y2)
   (object-goal object3 x9 y5)
   (object-goal object4 x4 y3)
   (object-goal object4 x10 y9)
   (object-goal object5 x4 y4)
   (object-goal object6 x5 y2)
   (object-goal object7 x5 y3)
   (object-goal object8 x5 y4)
   ...
   (object-pos object0 x6 y9)
   (object-pos object1 x5 y3)
   (object-pos object2 x3 y4)
   (object-pos object3 x10 y5)
   (object-pos object4 x10 y6)
   (object-pos object5 x10 y9)
   (object-pos object6 x6 y7)
   (object-pos object7 x9 y9)
   (object-pos object8 x8 y8)
