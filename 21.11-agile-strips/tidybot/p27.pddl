;  15 x 15 with 1 robots, 1 carts, 6 tables, and 3  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (object-goal object0 x5 y10)
   (object-goal object1 x5 y11)
   (object-goal object2 x6 y10)
   (object-goal object3 x6 y11)
   (object-goal object4 x10 y6)
   (object-goal object5 x10 y7)
   (object-goal object5 x11 y2)
   (object-goal object6 x11 y6)
   (object-goal object7 x11 y7)
   (object-goal object8 x3 y2)
   (object-goal object9 x3 y3)
   (object-goal object9 x2 y9)
   (object-goal object10 x4 y2)
   (object-goal object10 x11 y12)
   (object-goal object11 x4 y3)
   (object-goal object11 x3 y7)
   ...
   (base-obstacle x10 y12)(surface x10 y12)
   (base-obstacle x11 y12)(surface x11 y12)
   ...
   (base-obstacle x11 y1)(surface x11 y1)
   (base-obstacle x11 y2)(surface x11 y2)
   ...
   (base-obstacle x4 y12)(gripper-obstacle x4 y12)
   (base-obstacle x5 y9)(gripper-obstacle x5 y9)
   (base-obstacle x5 y12)(gripper-obstacle x5 y12)
   (base-obstacle x6 y9)(gripper-obstacle x6 y9)
   (base-obstacle x6 y12)(gripper-obstacle x6 y12)
   (base-obstacle x7 y9)(gripper-obstacle x7 y9)
   (base-obstacle x7 y12)(gripper-obstacle x7 y12)
   ...
   (base-obstacle x11 y8)(gripper-obstacle x11 y8)
   ...
   (object-pos object0 x1 y6)
   (object-pos object1 x9 y1)
   (object-pos object2 x11 y7)
   (object-pos object3 x11 y6)
   (object-pos object4 x9 y2)
   (object-pos object5 x11 y12)
   (object-pos object6 x3 y6)
   (object-pos object7 x6 y10)
   (object-pos object8 x1 y9)
   (object-pos object9 x5 y10)
