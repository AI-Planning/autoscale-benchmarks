;  10 x 10 with 1 robots, 1 carts, 5 tables, and 1  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-goal object2 x2 y4)
   (object-goal object2 x2 y7)
   (object-goal object3 x3 y2)
   (object-goal object4 x3 y3)
   (object-goal object5 x3 y4)
   (object-goal object5 x7 y7)
   (object-goal object6 x4 y2)
   (object-goal object6 x2 y7)
   (object-goal object7 x4 y3)
   (object-goal object7 x7 y7)
   (object-goal object8 x4 y4)
   ...
   (object-pos object1 x3 y4)
   (object-pos object2 x5 y7)
   (object-pos object3 x3 y3)
   (object-pos object4 x7 y4)
   (object-pos object5 x7 y1)
   (object-pos object6 x2 y2)
   (object-pos object7 x7 y7)
   (object-pos object8 x2 y3)
