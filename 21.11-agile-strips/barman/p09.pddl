(define (problem prob)
 ...
 (:goal
  (and
      (contains shot1 cocktail33)
      (contains shot2 cocktail25)
      (contains shot3 cocktail31)
      (contains shot4 cocktail15)
      (contains shot5 cocktail7)
      (contains shot6 cocktail27)
      (contains shot7 cocktail29)
      (contains shot8 cocktail13)
      (contains shot9 cocktail32)
      ...
      (contains shot27 cocktail17)
      (contains shot28 cocktail14)
      (contains shot29 cocktail19)
      (contains shot30 cocktail18)
      (contains shot31 cocktail3)
      (contains shot32 cocktail22)
      (contains shot33 cocktail21)
      (contains shot34 cocktail26)
      (contains shot35 cocktail18)
      (contains shot36 cocktail16)
      (contains shot37 cocktail34)
      (contains shot38 ingredient1)
      (contains shot39 cocktail9)
)))
