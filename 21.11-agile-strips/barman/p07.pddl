(define (problem prob)
 ...
 (:objects 
      shaker1 - shaker
      left right - hand
      shot1 shot2 shot3 shot4 shot5 shot6 shot7 shot8 shot9 shot10 shot11 shot12 shot13 shot14 shot15 shot16 shot17 shot18 shot19 shot20 shot21 shot22 shot23 shot24 shot25 shot26 shot27 shot28 shot29 shot30 shot31 shot32 shot33 - shot
      ingredient1 ingredient2 - ingredient
      cocktail1 cocktail2 cocktail3 cocktail4 cocktail5 cocktail6 cocktail7 cocktail8 cocktail9 cocktail10 cocktail11 cocktail12 cocktail13 cocktail14 cocktail15 cocktail16 cocktail17 cocktail18 cocktail19 cocktail20 cocktail21 cocktail22 cocktail23 cocktail24 cocktail25 cocktail26 cocktail27 - cocktail
 ...
 (:goal
  (and
      ...
      (contains shot12 cocktail20)
      (contains shot13 cocktail1)
      (contains shot14 cocktail27)
      (contains shot15 cocktail23)
      (contains shot16 cocktail24)
      (contains shot17 cocktail17)
      (contains shot18 cocktail13)
      (contains shot19 cocktail25)
      (contains shot20 cocktail22)
      (contains shot21 cocktail16)
      (contains shot22 cocktail4)
      (contains shot23 cocktail8)
      (contains shot24 cocktail2)
      (contains shot25 cocktail14)
      (contains shot26 cocktail15)
      (contains shot27 cocktail7)
      (contains shot28 ingredient1)
      (contains shot29 ingredient1)
      (contains shot30 ingredient1)
      (contains shot31 cocktail19)
