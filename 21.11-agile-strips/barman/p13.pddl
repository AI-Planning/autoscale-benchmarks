(define (problem prob)
 ...
 (:goal
  (and
      ...
      (contains shot2 cocktail39)
      (contains shot3 cocktail7)
      (contains shot4 cocktail11)
      (contains shot5 cocktail20)
      (contains shot6 cocktail18)
      (contains shot7 cocktail21)
      (contains shot8 cocktail16)
      (contains shot9 cocktail13)
      (contains shot10 cocktail28)
      (contains shot11 cocktail45)
      (contains shot12 cocktail4)
      (contains shot13 cocktail31)
      (contains shot14 cocktail43)
      (contains shot15 cocktail47)
      (contains shot16 cocktail23)
      (contains shot17 cocktail32)
      (contains shot18 cocktail37)
      (contains shot19 cocktail35)
      (contains shot20 cocktail42)
      (contains shot21 cocktail2)
      (contains shot22 cocktail17)
      (contains shot23 cocktail48)
      (contains shot24 cocktail49)
      (contains shot25 cocktail15)
      ...
      (contains shot31 cocktail44)
      (contains shot32 cocktail9)
      (contains shot33 cocktail41)
      (contains shot34 cocktail46)
      (contains shot35 cocktail29)
      (contains shot36 cocktail12)
      (contains shot37 cocktail19)
      (contains shot38 cocktail8)
      (contains shot39 cocktail5)
      (contains shot40 cocktail30)
      (contains shot41 cocktail33)
      (contains shot42 cocktail27)
      (contains shot43 cocktail26)
      (contains shot44 cocktail38)
      (contains shot45 cocktail25)
      (contains shot46 cocktail1)
      (contains shot47 cocktail34)
      (contains shot48 cocktail24)
      (contains shot49 cocktail3)
      (contains shot50 cocktail9)
      (contains shot51 ingredient2)
      (contains shot52 ingredient2)
      (contains shot53 cocktail24)
      (contains shot54 ingredient2)
      (contains shot55 cocktail5)
)))
