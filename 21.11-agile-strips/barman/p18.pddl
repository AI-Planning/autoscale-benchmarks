(define (problem prob)
 ...
 (:objects 
      shaker1 - shaker
      left right - hand
      shot1 shot2 shot3 shot4 shot5 shot6 shot7 shot8 shot9 shot10 shot11 shot12 shot13 shot14 shot15 shot16 shot17 shot18 shot19 shot20 shot21 shot22 shot23 shot24 shot25 shot26 shot27 shot28 shot29 shot30 shot31 shot32 shot33 shot34 shot35 shot36 shot37 shot38 shot39 shot40 shot41 shot42 shot43 shot44 shot45 shot46 shot47 shot48 shot49 shot50 shot51 shot52 shot53 shot54 shot55 shot56 shot57 shot58 shot59 shot60 shot61 shot62 shot63 shot64 shot65 shot66 shot67 shot68 shot69 shot70 shot71 shot72 shot73 shot74 shot75 - shot
      ingredient1 ingredient2 - ingredient
      cocktail1 cocktail2 cocktail3 cocktail4 cocktail5 cocktail6 cocktail7 cocktail8 cocktail9 cocktail10 cocktail11 cocktail12 cocktail13 cocktail14 cocktail15 cocktail16 cocktail17 cocktail18 cocktail19 cocktail20 cocktail21 cocktail22 cocktail23 cocktail24 cocktail25 cocktail26 cocktail27 cocktail28 cocktail29 cocktail30 cocktail31 cocktail32 cocktail33 cocktail34 cocktail35 cocktail36 cocktail37 cocktail38 cocktail39 cocktail40 cocktail41 cocktail42 cocktail43 cocktail44 cocktail45 cocktail46 cocktail47 cocktail48 cocktail49 cocktail50 cocktail51 cocktail52 cocktail53 cocktail54 cocktail55 cocktail56 cocktail57 cocktail58 cocktail59 cocktail60 cocktail61 cocktail62 cocktail63 cocktail64 cocktail65 cocktail66 cocktail67 - cocktail
 ...
 (:goal
  (and
      ...
      (contains shot2 cocktail30)
      (contains shot3 cocktail47)
      (contains shot4 cocktail10)
      (contains shot5 cocktail39)
      (contains shot6 cocktail11)
      (contains shot7 cocktail1)
      (contains shot8 cocktail17)
      (contains shot9 cocktail7)
      (contains shot10 cocktail56)
      (contains shot11 cocktail59)
      (contains shot12 cocktail51)
      ...
      (contains shot18 cocktail44)
      (contains shot19 cocktail46)
      (contains shot20 cocktail37)
      ...
      (contains shot26 cocktail18)
      (contains shot27 cocktail16)
      (contains shot28 cocktail36)
      (contains shot29 cocktail3)
      (contains shot30 cocktail13)
      (contains shot31 cocktail38)
      (contains shot32 cocktail49)
      (contains shot33 cocktail24)
      (contains shot34 cocktail54)
      (contains shot35 cocktail25)
      (contains shot36 cocktail60)
      (contains shot37 cocktail52)
      (contains shot38 cocktail6)
      (contains shot39 cocktail29)
      (contains shot40 cocktail58)
      (contains shot41 cocktail2)
      (contains shot42 cocktail12)
      (contains shot43 cocktail21)
      (contains shot44 cocktail50)
      (contains shot45 cocktail19)
      (contains shot46 cocktail5)
      (contains shot47 cocktail35)
      (contains shot48 cocktail55)
      (contains shot49 cocktail64)
      (contains shot50 cocktail34)
      (contains shot51 cocktail23)
      (contains shot52 cocktail26)
      (contains shot53 cocktail45)
      (contains shot54 cocktail43)
      (contains shot55 cocktail66)
      (contains shot56 cocktail62)
      (contains shot57 cocktail42)
      (contains shot58 cocktail48)
      (contains shot59 cocktail33)
      (contains shot60 cocktail40)
      (contains shot61 cocktail4)
      (contains shot62 cocktail63)
      (contains shot63 cocktail41)
      (contains shot64 cocktail20)
      (contains shot65 cocktail57)
      (contains shot66 cocktail22)
      (contains shot67 cocktail31)
      (contains shot68 ingredient2)
      (contains shot69 cocktail44)
      (contains shot70 ingredient1)
      (contains shot71 cocktail19)
      (contains shot72 ingredient2)
      (contains shot73 ingredient2)
