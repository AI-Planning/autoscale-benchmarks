(define (problem prob)
 ...
 (:goal
  (and
      ...
      (contains shot20 cocktail50)
      (contains shot21 cocktail14)
      (contains shot22 cocktail7)
      (contains shot23 cocktail1)
      (contains shot24 cocktail64)
      (contains shot25 cocktail33)
      (contains shot26 cocktail70)
      (contains shot27 cocktail57)
      (contains shot28 cocktail41)
      (contains shot29 cocktail55)
      (contains shot30 cocktail61)
      (contains shot31 cocktail23)
      (contains shot32 cocktail20)
      (contains shot33 cocktail58)
      (contains shot34 cocktail60)
      (contains shot35 cocktail36)
      (contains shot36 cocktail47)
      (contains shot37 cocktail40)
      (contains shot38 cocktail68)
      (contains shot39 cocktail66)
      (contains shot40 cocktail44)
      (contains shot41 cocktail22)
      (contains shot42 cocktail52)
      (contains shot43 cocktail48)
      (contains shot44 cocktail4)
      (contains shot45 cocktail9)
      (contains shot46 cocktail59)
      (contains shot47 cocktail13)
      (contains shot48 cocktail45)
      (contains shot49 cocktail62)
      (contains shot50 cocktail24)
      (contains shot51 cocktail32)
      (contains shot52 cocktail3)
      (contains shot53 cocktail8)
      (contains shot54 cocktail26)
      (contains shot55 cocktail28)
      (contains shot56 cocktail34)
      (contains shot57 cocktail11)
      (contains shot58 cocktail10)
      (contains shot59 cocktail18)
      (contains shot60 cocktail67)
      (contains shot61 cocktail35)
      (contains shot62 cocktail6)
      (contains shot63 cocktail31)
      (contains shot64 cocktail38)
      (contains shot65 cocktail19)
      (contains shot66 cocktail30)
      (contains shot67 cocktail27)
      (contains shot68 cocktail43)
      (contains shot69 cocktail46)
      (contains shot70 cocktail2)
      (contains shot71 ingredient1)
      (contains shot72 cocktail54)
      (contains shot73 ingredient2)
      (contains shot74 ingredient1)
      (contains shot75 cocktail27)
      (contains shot76 cocktail17)
      (contains shot77 ingredient2)
)))
