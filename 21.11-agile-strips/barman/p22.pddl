(define (problem prob)
 ...
 (:goal
  (and
      ...
      (contains shot16 cocktail12)
      (contains shot17 cocktail28)
      (contains shot18 cocktail5)
      (contains shot19 cocktail13)
