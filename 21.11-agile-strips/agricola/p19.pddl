(define (problem prob_agricola)
 (:domain agricola)
 (:objects 
num1 num2 num3 num4 num5 num6 num7 num8 num9 num10 num11 num12 num13 num14 num15 num16 num17 num18 - num 
stage1 stage2 stage3 stage4 stage5 stage6 stage7 stage8 stage9 stage10 stage11 stage12 stage13 - stage
round1 round2 round3 round4 round5 round6 round7 round8 round9 round10 round11 round12 round13 round14 round15 round16 round17 round18 round19 round20 round21 - round 
worker1 worker2 worker3 worker4 worker5 worker6 worker7 worker8 - worker 
room1 room2 room3 room4 room5 room6 room7 room8 - room 
 ...
 (:init 
    ...
    (NEXT_STAGE stage10 stage11)
    (NEXT_STAGE stage11 stage12)
    (NEXT_STAGE stage12 stage13)
    ...
    (NEXT_ROUND round18 round19)
    (NEXT_ROUND round19 round20)
    (NEXT_ROUND round20 round21)
    ...
    (category_round round19 tharvest)
    (category_round round20 tharvest)
    (category_round round21 tharvest)
    ...
    (DRAWCARD_ROUND void round19)
    (DRAWCARD_ROUND void round20)
    (DRAWCARD_ROUND void round21)
    ...
    (space_rooms room7)
    (space_rooms room8)
    (= (group_worker_cost worker2) 120)
    (= (group_worker_cost worker3) 90)
    (= (group_worker_cost worker4) 60)
    (= (group_worker_cost worker5) 30)
    (= (group_worker_cost worker6) 15)
    (= (group_worker_cost worker7) 6)
    (= (group_worker_cost worker8) 4))
 (:goal (and 
    (harvest_phase stage12 harvest_end)))
