(define (problem Tetris-18-2-2250648)
(:domain tetris)
(:objects  
...
(at_two straight1 f9-3f f8-3f)
(at_two straight2 f4-1f f4-2f)
(at_two straight3 f7-3f f7-2f)
(at_two straight4 f2-1f f2-2f)
(at_two straight5 f0-0f f0-1f)
(at_two straight6 f9-0f f10-0f)
(at_two straight7 f6-3f f6-2f)
 )
(:goal
(and
(clear f0-0f)
