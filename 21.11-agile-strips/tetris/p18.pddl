(define (problem Tetris-12-2-7284194)
(:domain tetris)
(:objects  
...
(clear f11-2f)
(clear f11-3f)
(at_two straight0 f6-3f f5-3f)
(at_two straight1 f2-3f f2-2f)
(at_two straight2 f6-2f f6-1f)
(at_two straight3 f2-1f f1-1f)
(at_two straight4 f4-2f f4-3f)
(at_two straight5 f2-0f f1-0f)
(at_two straight6 f3-0f f4-0f)
 )
(:goal
(and
(clear f0-0f)
