(define (problem p20-4-78-tiny-network-2046)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           (SCRIPT-IO script1 data-0-7 data-0-1 data-1-2)
           (SCRIPT-IO script2 data-0-12 data-0-14 data-1-9)
           (SCRIPT-IO script3 data-0-7 data-0-12 data-1-19)
           (SCRIPT-IO script4 data-1-19 data-0-17 data-2-3)
           (SCRIPT-IO script5 data-1-19 data-1-2 data-2-8)
           (SCRIPT-IO script6 data-1-19 data-0-5 data-2-13)
           (SCRIPT-IO script7 data-1-2 data-1-19 data-2-16)
           (SCRIPT-IO script8 data-2-3 data-0-11 data-3-4)
           (SCRIPT-IO script9 data-2-3 data-2-16 data-3-6)
           (SCRIPT-IO script10 data-2-8 data-2-16 data-3-10)
           (SCRIPT-IO script11 data-2-3 data-2-13 data-3-15)
           (SCRIPT-IO script12 data-2-3 data-1-19 data-3-18)
           (SCRIPT-IO script13 data-2-8 data-0-14 data-3-20)
           (SCRIPT-IO script14 data-0-17 data-0-7 data-1-19)
           (SCRIPT-IO script15 data-2-16 data-1-19 data-3-6)
           (SCRIPT-IO script16 data-0-5 data-0-17 data-1-9)
           (SCRIPT-IO script17 data-0-11 data-0-17 data-1-2)
           (SCRIPT-IO script18 data-0-7 data-0-12 data-1-19)
           (SCRIPT-IO script19 data-2-3 data-0-14 data-3-18)
           (SCRIPT-IO script20 data-1-9 data-1-19 data-2-8)
           (SCRIPT-IO script21 data-2-3 data-2-13 data-3-20)
           (SCRIPT-IO script22 data-2-3 data-0-5 data-3-20)
           (SCRIPT-IO script23 data-1-9 data-0-14 data-2-3)
           (SCRIPT-IO script24 data-1-19 data-1-2 data-2-13)
           (SCRIPT-IO script25 data-2-13 data-0-7 data-3-10)
           (SCRIPT-IO script26 data-2-13 data-1-9 data-3-15)
           (SCRIPT-IO script27 data-2-13 data-1-9 data-3-20)
           (SCRIPT-IO script28 data-0-5 data-0-14 data-1-2)
           (SCRIPT-IO script29 data-1-19 data-1-9 data-2-3)
           (SCRIPT-IO script30 data-2-3 data-0-5 data-3-10)
           (SCRIPT-IO script31 data-1-2 data-1-9 data-2-16)
           (SCRIPT-IO script32 data-2-8 data-1-9 data-3-18)
           (SCRIPT-IO script33 data-0-14 data-0-12 data-1-19)
           (SCRIPT-IO script34 data-1-9 data-0-14 data-2-8)
           (SCRIPT-IO script35 data-1-9 data-1-2 data-2-3)
           (SCRIPT-IO script36 data-1-19 data-1-2 data-2-3)
           (SCRIPT-IO script37 data-1-2 data-1-9 data-2-16)
           (SCRIPT-IO script38 data-2-8 data-1-2 data-3-6)
           (SCRIPT-IO script39 data-2-16 data-2-3 data-3-20)
           (SCRIPT-IO script40 data-0-11 data-0-1 data-1-9)
           (SCRIPT-IO script41 data-0-12 data-0-14 data-1-19)
           (SCRIPT-IO script42 data-1-19 data-1-2 data-2-3)
           (SCRIPT-IO script43 data-0-14 data-0-17 data-1-9)
           (SCRIPT-IO script44 data-2-16 data-0-11 data-3-10)
           (SCRIPT-IO script45 data-1-2 data-0-7 data-2-3)
           (SCRIPT-IO script46 data-0-14 data-0-11 data-1-9)
           (SCRIPT-IO script47 data-1-19 data-0-1 data-2-16)
           (SCRIPT-IO script48 data-1-2 data-1-9 data-2-3)
           (SCRIPT-IO script49 data-1-9 data-0-14 data-2-8)
           (SCRIPT-IO script50 data-0-1 data-0-7 data-1-2)
           (SCRIPT-IO script51 data-1-9 data-1-2 data-2-3)
           (SCRIPT-IO script52 data-0-11 data-0-14 data-1-19)
           (SCRIPT-IO script53 data-0-11 data-0-14 data-1-19)
           (SCRIPT-IO script54 data-0-5 data-0-11 data-1-19)
           (SCRIPT-IO script55 data-2-13 data-1-9 data-3-18)
           (SCRIPT-IO script56 data-2-3 data-0-12 data-3-4)
           (SCRIPT-IO script57 data-0-12 data-0-14 data-1-19)
           (SCRIPT-IO script58 data-0-17 data-0-1 data-1-9)
           (SCRIPT-IO script59 data-1-19 data-0-5 data-2-16)
           (SCRIPT-IO script60 data-1-9 data-0-12 data-2-16)
           (SCRIPT-IO script61 data-2-13 data-2-8 data-3-10)
           (SCRIPT-IO script62 data-2-13 data-1-2 data-3-20)
           (SCRIPT-IO script63 data-1-19 data-0-1 data-2-3)
           (SCRIPT-IO script64 data-2-16 data-2-8 data-3-15)
           (SCRIPT-IO script65 data-0-12 data-0-11 data-1-19)
           (SCRIPT-IO script66 data-2-13 data-0-17 data-3-4)
           (SCRIPT-IO script67 data-0-12 data-0-17 data-1-19)
           (SCRIPT-IO script68 data-2-8 data-0-1 data-3-10)
           (SCRIPT-IO script69 data-2-13 data-0-5 data-3-20)
           (SCRIPT-IO script70 data-0-7 data-0-12 data-1-9)
           (SCRIPT-IO script71 data-1-9 data-1-19 data-2-13)
           (SCRIPT-IO script72 data-1-2 data-1-19 data-2-3)
           (SCRIPT-IO script73 data-0-1 data-0-14 data-1-2)
           (SCRIPT-IO script74 data-1-19 data-1-2 data-2-13)
           (SCRIPT-IO script75 data-0-11 data-0-14 data-1-19)
           (SCRIPT-IO script76 data-2-16 data-0-17 data-3-10)
           (SCRIPT-IO script77 data-0-7 data-0-12 data-1-2)
           (SCRIPT-IO script78 data-1-19 data-1-9 data-2-13)
           ...
           (DATA-SIZE data-3-15 number3)
           (DATA-SIZE data-3-18 number5)
           ...
           (= (process-cost script2 server1) 20)
           ...
           (= (process-cost script3 server3) 7)
           ...
           (= (process-cost script11 server1) 20)
           (= (process-cost script11 server2) 11)
           (= (process-cost script11 server3) 7)
           ...
           (= (process-cost script16 server1) 24)
           ...
           (= (process-cost script36 server1) 30)
           ...
           (= (process-cost script38 server1) 23)
           ...
           (= (process-cost script44 server1) 23)
           ...
           (= (process-cost script55 server3) 4)
           ...
           (= (process-cost script69 server1) 15)
           (= (process-cost script69 server2) 12)
           ...
           (= (process-cost script73 server1) 21)
           (= (process-cost script73 server2) 12)
           (= (process-cost script73 server3) 8)
           (= (process-cost script74 server1) 14)
           (= (process-cost script74 server2) 13)
           (= (process-cost script74 server3) 7)
           (= (process-cost script75 server1) 29)
           (= (process-cost script75 server2) 10)
           (= (process-cost script75 server3) 12)
           (= (process-cost script76 server1) 15)
           (= (process-cost script76 server2) 5)
    ...
    (:goal
           (and
                ...
                (saved data-3-15 server2)
                (saved data-3-18 server3)
                (saved data-3-20 server2)
           )
    )
