(define (problem p6-3-29-tiny-network-2020)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           (SCRIPT-IO script1 data-0-1 data-0-5 data-1-2)
           (SCRIPT-IO script2 data-0-4 data-0-5 data-1-6)
           (SCRIPT-IO script3 data-1-2 data-0-1 data-2-3)
           (SCRIPT-IO script4 data-0-1 data-0-4 data-1-2)
           (SCRIPT-IO script5 data-1-6 data-1-2 data-2-3)
           (SCRIPT-IO script6 data-1-2 data-1-6 data-2-3)
           (SCRIPT-IO script7 data-0-5 data-0-4 data-1-2)
           (SCRIPT-IO script8 data-0-5 data-0-1 data-1-2)
           (SCRIPT-IO script9 data-0-1 data-0-4 data-1-6)
           (SCRIPT-IO script10 data-0-5 data-0-1 data-1-6)
           (SCRIPT-IO script11 data-1-6 data-0-5 data-2-3)
           (SCRIPT-IO script12 data-1-6 data-0-5 data-2-3)
           (SCRIPT-IO script13 data-0-5 data-0-1 data-1-2)
           (SCRIPT-IO script14 data-0-4 data-0-5 data-1-6)
           (SCRIPT-IO script15 data-1-6 data-0-1 data-2-3)
           (SCRIPT-IO script16 data-0-5 data-0-1 data-1-6)
           (SCRIPT-IO script17 data-0-5 data-0-1 data-1-2)
           (SCRIPT-IO script18 data-0-4 data-0-1 data-1-2)
           (SCRIPT-IO script19 data-1-6 data-1-2 data-2-3)
           (SCRIPT-IO script20 data-1-6 data-0-4 data-2-3)
           (SCRIPT-IO script21 data-0-5 data-0-4 data-1-6)
           (SCRIPT-IO script22 data-1-6 data-1-2 data-2-3)
           (SCRIPT-IO script23 data-1-6 data-0-1 data-2-3)
           (SCRIPT-IO script24 data-0-5 data-0-1 data-1-2)
           (SCRIPT-IO script25 data-1-2 data-0-5 data-2-3)
           (SCRIPT-IO script26 data-1-2 data-1-6 data-2-3)
           (SCRIPT-IO script27 data-1-2 data-0-1 data-2-3)
           (SCRIPT-IO script28 data-1-2 data-0-4 data-2-3)
           (SCRIPT-IO script29 data-0-4 data-0-5 data-1-2)
           ...
           (= (total-cost) 0)
           (= (process-cost script1 server1) 15)
           ...
           (= (process-cost script3 server1) 28)
           ...
           (= (process-cost script9 server3) 15)
           ...
           (= (process-cost script14 server1) 15)
           (= (process-cost script14 server2) 5)
           (= (process-cost script14 server3) 14)
           (= (process-cost script15 server1) 16)
           (= (process-cost script15 server2) 9)
           (= (process-cost script15 server3) 9)
           (= (process-cost script16 server1) 18)
           ...
           (= (process-cost script17 server3) 7)
           ...
           (= (process-cost script23 server1) 26)
           ...
           (= (process-cost script29 server3) 7)
