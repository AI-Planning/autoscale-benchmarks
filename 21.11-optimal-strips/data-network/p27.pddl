(define (problem p19-4-74-tiny-network-2045)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           (SCRIPT-IO script1 data-0-5 data-0-10 data-1-2)
           (SCRIPT-IO script2 data-0-1 data-0-7 data-1-9)
           (SCRIPT-IO script3 data-0-5 data-0-10 data-1-11)
           (SCRIPT-IO script4 data-0-10 data-0-5 data-1-12)
           (SCRIPT-IO script5 data-0-7 data-0-1 data-1-18)
           (SCRIPT-IO script6 data-1-12 data-1-18 data-2-3)
           (SCRIPT-IO script7 data-1-12 data-0-5 data-2-15)
           (SCRIPT-IO script8 data-1-9 data-1-2 data-2-16)
           (SCRIPT-IO script9 data-2-16 data-2-3 data-3-4)
           (SCRIPT-IO script10 data-2-16 data-0-8 data-3-6)
           (SCRIPT-IO script11 data-2-3 data-0-7 data-3-14)
           (SCRIPT-IO script12 data-2-15 data-0-1 data-3-17)
           (SCRIPT-IO script13 data-2-16 data-1-9 data-3-19)
           (SCRIPT-IO script14 data-1-2 data-0-10 data-2-3)
           (SCRIPT-IO script15 data-1-9 data-1-18 data-2-16)
           (SCRIPT-IO script16 data-1-12 data-0-13 data-2-15)
           (SCRIPT-IO script17 data-1-11 data-1-2 data-2-15)
           (SCRIPT-IO script18 data-2-3 data-0-13 data-3-6)
           (SCRIPT-IO script19 data-0-5 data-0-7 data-1-12)
           (SCRIPT-IO script20 data-0-10 data-0-7 data-1-12)
           (SCRIPT-IO script21 data-0-7 data-0-8 data-1-9)
           (SCRIPT-IO script22 data-0-1 data-0-13 data-1-11)
           (SCRIPT-IO script23 data-2-16 data-0-10 data-3-6)
           (SCRIPT-IO script24 data-2-3 data-0-7 data-3-4)
           (SCRIPT-IO script25 data-0-1 data-0-5 data-1-11)
           (SCRIPT-IO script26 data-0-5 data-0-13 data-1-18)
           (SCRIPT-IO script27 data-1-9 data-0-10 data-2-3)
           (SCRIPT-IO script28 data-2-3 data-0-10 data-3-14)
           (SCRIPT-IO script29 data-0-8 data-0-1 data-1-18)
           (SCRIPT-IO script30 data-2-15 data-1-12 data-3-17)
           (SCRIPT-IO script31 data-0-5 data-0-8 data-1-9)
           (SCRIPT-IO script32 data-2-16 data-1-12 data-3-14)
           (SCRIPT-IO script33 data-2-15 data-1-11 data-3-19)
           (SCRIPT-IO script34 data-0-8 data-0-7 data-1-12)
           (SCRIPT-IO script35 data-1-12 data-0-10 data-2-15)
           (SCRIPT-IO script36 data-2-15 data-0-1 data-3-19)
           (SCRIPT-IO script37 data-2-3 data-0-13 data-3-4)
           (SCRIPT-IO script38 data-2-3 data-0-5 data-3-19)
           (SCRIPT-IO script39 data-0-10 data-0-7 data-1-2)
           (SCRIPT-IO script40 data-1-2 data-1-11 data-2-15)
           (SCRIPT-IO script41 data-1-11 data-1-9 data-2-3)
           (SCRIPT-IO script42 data-0-1 data-0-5 data-1-18)
           (SCRIPT-IO script43 data-0-7 data-0-13 data-1-9)
           (SCRIPT-IO script44 data-2-15 data-2-16 data-3-4)
           (SCRIPT-IO script45 data-1-12 data-1-18 data-2-15)
           (SCRIPT-IO script46 data-0-13 data-0-7 data-1-2)
           (SCRIPT-IO script47 data-2-15 data-1-18 data-3-6)
           (SCRIPT-IO script48 data-1-11 data-1-12 data-2-15)
           (SCRIPT-IO script49 data-0-7 data-0-10 data-1-11)
           (SCRIPT-IO script50 data-2-3 data-1-2 data-3-6)
           (SCRIPT-IO script51 data-0-7 data-0-5 data-1-11)
           (SCRIPT-IO script52 data-2-16 data-2-15 data-3-19)
           (SCRIPT-IO script53 data-2-15 data-0-13 data-3-4)
           (SCRIPT-IO script54 data-1-11 data-0-10 data-2-15)
           (SCRIPT-IO script55 data-0-8 data-0-13 data-1-18)
           (SCRIPT-IO script56 data-0-5 data-0-10 data-1-9)
           (SCRIPT-IO script57 data-2-15 data-1-12 data-3-14)
           (SCRIPT-IO script58 data-2-3 data-1-18 data-3-19)
           (SCRIPT-IO script59 data-0-13 data-0-10 data-1-9)
           (SCRIPT-IO script60 data-0-7 data-0-10 data-1-11)
           (SCRIPT-IO script61 data-2-16 data-1-11 data-3-4)
           (SCRIPT-IO script62 data-0-13 data-0-7 data-1-11)
           (SCRIPT-IO script63 data-0-10 data-0-8 data-1-9)
           (SCRIPT-IO script64 data-0-13 data-0-5 data-1-2)
           (SCRIPT-IO script65 data-1-18 data-1-11 data-2-16)
           (SCRIPT-IO script66 data-2-3 data-1-2 data-3-6)
           (SCRIPT-IO script67 data-1-18 data-1-2 data-2-3)
           (SCRIPT-IO script68 data-0-10 data-0-8 data-1-12)
           (SCRIPT-IO script69 data-1-12 data-0-5 data-2-3)
           (SCRIPT-IO script70 data-0-1 data-0-5 data-1-11)
           (SCRIPT-IO script71 data-1-2 data-0-10 data-2-15)
           (SCRIPT-IO script72 data-0-8 data-0-13 data-1-12)
           (SCRIPT-IO script73 data-0-5 data-0-1 data-1-11)
           (SCRIPT-IO script74 data-0-1 data-0-13 data-1-9)
           ...
           (= (process-cost script3 server1) 23)
           ...
           (= (process-cost script8 server1) 22)
           ...
           (= (process-cost script11 server1) 17)
           (= (process-cost script11 server2) 8)
           (= (process-cost script11 server3) 7)
           (= (process-cost script12 server1) 27)
           ...
           (= (process-cost script18 server1) 17)
           ...
           (= (process-cost script25 server1) 19)
           (= (process-cost script25 server2) 8)
           (= (process-cost script25 server3) 9)
           (= (process-cost script26 server1) 19)
           ...
           (= (process-cost script34 server1) 21)
           ...
           (= (process-cost script38 server3) 8)
           (= (process-cost script39 server1) 17)
           (= (process-cost script39 server2) 8)
           (= (process-cost script39 server3) 12)
           ...
           (= (process-cost script52 server1) 27)
           ...
           (= (process-cost script54 server1) 26)
           (= (process-cost script54 server2) 4)
           ...
           (= (process-cost script56 server1) 13)
           (= (process-cost script56 server2) 8)
           (= (process-cost script56 server3) 11)
           (= (process-cost script57 server1) 20)
           (= (process-cost script57 server2) 7)
           ...
           (= (process-cost script60 server1) 20)
           ...
           (= (process-cost script67 server1) 22)
           (= (process-cost script67 server2) 7)
           ...
           (= (process-cost script69 server2) 6)
           (= (process-cost script69 server3) 8)
           (= (process-cost script70 server1) 25)
           ...
           (= (process-cost script72 server1) 14)
           ...
           (= (process-cost script74 server1) 19)
    ...
    (:goal
           (and
                ...
                (saved data-3-17 server3)
                (saved data-3-19 server2)
           )
    )
