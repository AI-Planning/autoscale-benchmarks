(define (problem p14-3-62-tiny-network-2028)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           (SCRIPT-IO script1 data-0-4 data-0-7 data-1-2)
           (SCRIPT-IO script2 data-0-1 data-0-13 data-1-6)
           (SCRIPT-IO script3 data-0-1 data-0-4 data-1-9)
           (SCRIPT-IO script4 data-0-13 data-0-11 data-1-12)
           (SCRIPT-IO script5 data-1-12 data-0-7 data-2-3)
           (SCRIPT-IO script6 data-1-9 data-1-6 data-2-5)
           (SCRIPT-IO script7 data-1-12 data-1-9 data-2-8)
           (SCRIPT-IO script8 data-1-6 data-0-1 data-2-10)
           (SCRIPT-IO script9 data-1-9 data-0-13 data-2-14)
           (SCRIPT-IO script10 data-1-12 data-1-9 data-2-3)
           (SCRIPT-IO script11 data-0-4 data-0-7 data-1-2)
           (SCRIPT-IO script12 data-0-1 data-0-13 data-1-9)
           (SCRIPT-IO script13 data-0-4 data-0-1 data-1-12)
           (SCRIPT-IO script14 data-1-2 data-0-1 data-2-10)
           (SCRIPT-IO script15 data-1-2 data-1-6 data-2-8)
           (SCRIPT-IO script16 data-0-11 data-0-13 data-1-2)
           (SCRIPT-IO script17 data-1-2 data-0-11 data-2-14)
           (SCRIPT-IO script18 data-1-2 data-1-6 data-2-5)
           (SCRIPT-IO script19 data-0-7 data-0-1 data-1-6)
           (SCRIPT-IO script20 data-1-12 data-0-7 data-2-8)
           (SCRIPT-IO script21 data-1-9 data-0-13 data-2-3)
           (SCRIPT-IO script22 data-0-7 data-0-11 data-1-9)
           (SCRIPT-IO script23 data-1-9 data-0-4 data-2-14)
           (SCRIPT-IO script24 data-0-7 data-0-4 data-1-6)
           (SCRIPT-IO script25 data-1-12 data-0-11 data-2-5)
           (SCRIPT-IO script26 data-0-4 data-0-11 data-1-9)
           (SCRIPT-IO script27 data-0-4 data-0-11 data-1-12)
           (SCRIPT-IO script28 data-0-11 data-0-1 data-1-12)
           (SCRIPT-IO script29 data-1-12 data-1-9 data-2-5)
           (SCRIPT-IO script30 data-0-11 data-0-1 data-1-9)
           (SCRIPT-IO script31 data-0-13 data-0-4 data-1-2)
           (SCRIPT-IO script32 data-1-12 data-0-13 data-2-8)
           (SCRIPT-IO script33 data-0-4 data-0-1 data-1-6)
           (SCRIPT-IO script34 data-1-9 data-1-6 data-2-3)
           (SCRIPT-IO script35 data-0-1 data-0-11 data-1-9)
           (SCRIPT-IO script36 data-1-9 data-1-2 data-2-14)
           (SCRIPT-IO script37 data-0-11 data-0-4 data-1-9)
           (SCRIPT-IO script38 data-0-4 data-0-1 data-1-6)
           (SCRIPT-IO script39 data-0-1 data-0-4 data-1-2)
           (SCRIPT-IO script40 data-1-2 data-0-13 data-2-10)
           (SCRIPT-IO script41 data-0-11 data-0-7 data-1-6)
           (SCRIPT-IO script42 data-1-12 data-1-9 data-2-14)
           (SCRIPT-IO script43 data-0-7 data-0-11 data-1-2)
           (SCRIPT-IO script44 data-0-1 data-0-13 data-1-2)
           (SCRIPT-IO script45 data-0-1 data-0-7 data-1-9)
           (SCRIPT-IO script46 data-0-13 data-0-4 data-1-2)
           (SCRIPT-IO script47 data-1-12 data-1-2 data-2-14)
           (SCRIPT-IO script48 data-0-4 data-0-1 data-1-9)
           (SCRIPT-IO script49 data-1-12 data-0-13 data-2-3)
           (SCRIPT-IO script50 data-1-2 data-1-12 data-2-3)
           (SCRIPT-IO script51 data-1-12 data-1-2 data-2-8)
           (SCRIPT-IO script52 data-1-2 data-0-11 data-2-5)
           (SCRIPT-IO script53 data-0-1 data-0-11 data-1-6)
           (SCRIPT-IO script54 data-1-2 data-0-7 data-2-5)
           (SCRIPT-IO script55 data-1-6 data-0-4 data-2-5)
           (SCRIPT-IO script56 data-0-1 data-0-11 data-1-9)
           (SCRIPT-IO script57 data-1-2 data-0-11 data-2-14)
           (SCRIPT-IO script58 data-1-6 data-0-1 data-2-8)
           (SCRIPT-IO script59 data-0-1 data-0-11 data-1-2)
           (SCRIPT-IO script60 data-0-11 data-0-4 data-1-2)
           (SCRIPT-IO script61 data-0-7 data-0-4 data-1-12)
           (SCRIPT-IO script62 data-1-12 data-1-9 data-2-14)
           ...
           (DATA-SIZE data-0-13 number3)
           (DATA-SIZE data-1-2 number4)
           (DATA-SIZE data-1-6 number1)
           (DATA-SIZE data-1-9 number4)
           (DATA-SIZE data-1-12 number4)
           (DATA-SIZE data-2-3 number4)
           (DATA-SIZE data-2-5 number4)
           (DATA-SIZE data-2-8 number1)
           ...
           (= (process-cost script1 server3) 5)
           ...
           (= (process-cost script4 server1) 22)
           (= (process-cost script4 server2) 10)
           (= (process-cost script4 server3) 7)
           (= (process-cost script5 server1) 22)
           ...
           (= (process-cost script6 server3) 5)
           (= (process-cost script7 server1) 17)
           ...
           (= (process-cost script9 server2) 6)
           ...
           (= (process-cost script13 server2) 15)
           ...
           (= (process-cost script24 server2) 5)
           (= (process-cost script24 server3) 10)
           (= (process-cost script25 server1) 27)
           ...
           (= (process-cost script28 server1) 14)
           (= (process-cost script28 server2) 5)
           (= (process-cost script28 server3) 7)
           (= (process-cost script29 server1) 19)
           ...
           (= (process-cost script33 server1) 24)
           (= (process-cost script33 server2) 11)
           (= (process-cost script33 server3) 7)
           (= (process-cost script34 server1) 23)
           (= (process-cost script34 server2) 9)
           (= (process-cost script34 server3) 15)
           (= (process-cost script35 server1) 26)
           ...
           (= (process-cost script37 server3) 12)
           ...
           (= (process-cost script45 server1) 14)
           ...
           (= (process-cost script54 server1) 14)
           (= (process-cost script54 server2) 11)
           (= (process-cost script54 server3) 7)
           (= (process-cost script55 server1) 16)
           (= (process-cost script55 server2) 6)
           ...
           (= (process-cost script60 server1) 12)
           (= (process-cost script60 server2) 8)
           (= (process-cost script60 server3) 9)
           (= (process-cost script61 server1) 25)
           (= (process-cost script61 server2) 11)
           (= (process-cost script61 server3) 7)
           (= (process-cost script62 server1) 28)
           (= (process-cost script62 server2) 6)
           (= (process-cost script62 server3) 9)
           ...
           (saved data-0-11 server1)
           (saved data-0-13 server2)
