(define (problem p16-4-64-tiny-network-2042)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           (SCRIPT-IO script1 data-0-5 data-0-12 data-1-2)
           (SCRIPT-IO script2 data-0-1 data-0-12 data-1-6)
           (SCRIPT-IO script3 data-0-1 data-0-12 data-1-7)
           (SCRIPT-IO script4 data-1-2 data-1-7 data-2-3)
           (SCRIPT-IO script5 data-1-2 data-1-6 data-2-10)
           (SCRIPT-IO script6 data-1-7 data-0-12 data-2-14)
           (SCRIPT-IO script7 data-1-6 data-0-12 data-2-16)
           (SCRIPT-IO script8 data-2-10 data-0-12 data-3-4)
           (SCRIPT-IO script9 data-2-14 data-0-5 data-3-8)
           (SCRIPT-IO script10 data-2-3 data-0-12 data-3-9)
           (SCRIPT-IO script11 data-2-16 data-0-5 data-3-11)
           (SCRIPT-IO script12 data-2-10 data-1-2 data-3-13)
           (SCRIPT-IO script13 data-2-16 data-1-6 data-3-15)
           (SCRIPT-IO script14 data-1-7 data-1-2 data-2-3)
           (SCRIPT-IO script15 data-1-2 data-0-5 data-2-14)
           (SCRIPT-IO script16 data-0-12 data-0-1 data-1-6)
           (SCRIPT-IO script17 data-2-10 data-0-12 data-3-11)
           (SCRIPT-IO script18 data-2-16 data-0-1 data-3-4)
           (SCRIPT-IO script19 data-0-5 data-0-1 data-1-2)
           (SCRIPT-IO script20 data-1-6 data-0-1 data-2-3)
           (SCRIPT-IO script21 data-2-16 data-2-3 data-3-13)
           (SCRIPT-IO script22 data-0-5 data-0-1 data-1-2)
           (SCRIPT-IO script23 data-2-10 data-2-14 data-3-13)
           (SCRIPT-IO script24 data-2-3 data-1-6 data-3-4)
           (SCRIPT-IO script25 data-1-6 data-1-2 data-2-16)
           (SCRIPT-IO script26 data-1-6 data-0-1 data-2-16)
           (SCRIPT-IO script27 data-1-2 data-0-1 data-2-10)
           (SCRIPT-IO script28 data-1-7 data-0-5 data-2-3)
           (SCRIPT-IO script29 data-2-16 data-0-12 data-3-15)
           (SCRIPT-IO script30 data-0-12 data-0-1 data-1-6)
           (SCRIPT-IO script31 data-2-10 data-0-5 data-3-15)
           (SCRIPT-IO script32 data-0-5 data-0-12 data-1-7)
           (SCRIPT-IO script33 data-2-16 data-1-2 data-3-15)
           (SCRIPT-IO script34 data-1-7 data-1-6 data-2-16)
           (SCRIPT-IO script35 data-2-16 data-0-5 data-3-8)
           (SCRIPT-IO script36 data-1-2 data-1-6 data-2-14)
           (SCRIPT-IO script37 data-1-7 data-1-6 data-2-10)
           (SCRIPT-IO script38 data-0-12 data-0-5 data-1-7)
           (SCRIPT-IO script39 data-2-3 data-1-2 data-3-8)
           (SCRIPT-IO script40 data-2-3 data-0-5 data-3-13)
           (SCRIPT-IO script41 data-1-7 data-0-12 data-2-10)
           (SCRIPT-IO script42 data-2-3 data-2-10 data-3-4)
           (SCRIPT-IO script43 data-1-2 data-0-1 data-2-16)
           (SCRIPT-IO script44 data-0-12 data-0-5 data-1-2)
           (SCRIPT-IO script45 data-0-1 data-0-5 data-1-6)
           (SCRIPT-IO script46 data-1-7 data-0-12 data-2-14)
           (SCRIPT-IO script47 data-0-5 data-0-12 data-1-2)
           (SCRIPT-IO script48 data-2-16 data-1-2 data-3-9)
           (SCRIPT-IO script49 data-0-12 data-0-5 data-1-2)
           (SCRIPT-IO script50 data-1-2 data-0-12 data-2-10)
           (SCRIPT-IO script51 data-0-1 data-0-12 data-1-2)
           (SCRIPT-IO script52 data-1-6 data-0-5 data-2-14)
           (SCRIPT-IO script53 data-0-1 data-0-12 data-1-2)
           (SCRIPT-IO script54 data-2-14 data-1-6 data-3-8)
           (SCRIPT-IO script55 data-0-5 data-0-12 data-1-6)
           (SCRIPT-IO script56 data-0-12 data-0-1 data-1-7)
           (SCRIPT-IO script57 data-1-6 data-1-2 data-2-10)
           (SCRIPT-IO script58 data-2-10 data-2-14 data-3-15)
           (SCRIPT-IO script59 data-1-2 data-1-6 data-2-14)
           (SCRIPT-IO script60 data-0-5 data-0-12 data-1-2)
           (SCRIPT-IO script61 data-0-1 data-0-12 data-1-7)
           (SCRIPT-IO script62 data-2-14 data-1-2 data-3-9)
           (SCRIPT-IO script63 data-1-2 data-0-5 data-2-14)
           (SCRIPT-IO script64 data-2-14 data-0-12 data-3-4)
           ...
           (DATA-SIZE data-3-9 number4)
           (DATA-SIZE data-3-11 number3)
           (DATA-SIZE data-3-13 number1)
           (DATA-SIZE data-3-15 number4)
           ...
           (= (process-cost script14 server1) 21)
           ...
           (= (process-cost script17 server3) 6)
           ...
           (= (process-cost script20 server1) 18)
           ...
           (= (process-cost script27 server2) 3)
           ...
           (= (process-cost script29 server2) 11)
           ...
           (= (process-cost script33 server1) 17)
           ...
           (= (process-cost script44 server1) 20)
           (= (process-cost script44 server2) 10)
           (= (process-cost script44 server3) 7)
           (= (process-cost script45 server1) 27)
           ...
           (= (process-cost script51 server1) 28)
           (= (process-cost script51 server2) 11)
           (= (process-cost script51 server3) 11)
           (= (process-cost script52 server1) 13)
           ...
           (= (process-cost script56 server1) 29)
           (= (process-cost script56 server2) 7)
           (= (process-cost script56 server3) 10)
           (= (process-cost script57 server1) 18)
           (= (process-cost script57 server2) 13)
           ...
           (= (process-cost script60 server1) 16)
           ...
           (= (process-cost script62 server1) 26)
           (= (process-cost script62 server2) 11)
           (= (process-cost script62 server3) 7)
    ...
    (:goal
           (and
                ...
                (saved data-3-11 server2)
                (saved data-3-13 server1)
