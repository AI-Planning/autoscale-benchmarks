;  10 x 10 with 1 robots, 1 carts, 4 tables, and 1  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-goal object1 x1 y5)
   (object-goal object2 x5 y3)
   (object-goal object3 x5 y4)
   (object-goal object3 x1 y1)
   ...
   (object-pos object0 x3 y7)
   (object-pos object1 x2 y7)
