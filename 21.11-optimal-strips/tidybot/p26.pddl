;  11 x 11 with 1 robots, 1 carts, 2 tables, and 1  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (object-goal object0 x4 y3)
   (object-goal object0 x4 y8)
   (object-goal object1 x4 y4)
   (object-goal object1 x4 y8)
   (object-goal object2 x4 y5)
   (object-goal object2 x1 y5)
   (object-goal object3 x5 y3)
   (object-goal object4 x5 y4)
   (object-goal object4 x4 y8)
   (object-goal object5 x5 y5)
   (object-goal object5 x4 y8)
   (object-goal object6 x6 y3)
   (object-goal object7 x6 y4)
   (object-goal object8 x6 y5)
   (object-goal object8 x1 y5)
   ...
   (object-pos object0 x4 y8)
   (object-pos object1 x6 y3)
   (object-pos object2 x1 y5)
   (object-pos object3 x5 y5)
   (object-pos object4 x4 y3)
   (object-pos object5 x4 y4)
   (object-pos object6 x5 y3)
   (object-pos object7 x6 y4)
   (object-pos object8 x4 y5)
   
   (gripper-empty pr2)
   (gripper-rel pr2 xrel0 yrel0)
   (gripper-obstacle x4 y8)
