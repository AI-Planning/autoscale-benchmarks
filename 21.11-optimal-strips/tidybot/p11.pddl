;  9 x 9 with 1 robots, 1 carts, 5 tables, and 1  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (base-obstacle x6 y5)(surface x6 y5)
   ...
   (object-pos object1 x2 y2)
   (object-pos object2 x1 y6)
