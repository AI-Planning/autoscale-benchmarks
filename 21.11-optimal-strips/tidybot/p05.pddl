;  11 x 11 with 1 robots, 1 carts, 7 tables, and 1  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (object-goal object0 x1 y8)
   (object-goal object1 x5 y4)
   (object-goal object2 x6 y3)
   (object-goal object2 x5 y8)
   ...
   (object-pos object0 x5 y3)
   (object-pos object1 x6 y3)
   (object-pos object2 x5 y8)
