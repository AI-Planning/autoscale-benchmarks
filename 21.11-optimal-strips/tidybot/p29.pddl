;  13 x 13 with 1 robots, 1 carts, 1 tables, and 2  cupboards
(define 
  (problem test) 
  (:domain TIDYBOT) 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (object-goal object0 x8 y5)
   (object-goal object0 x5 y8)
   (object-goal object1 x8 y6)
   (object-goal object1 x4 y9)
   (object-goal object2 x9 y5)
   (object-goal object3 x9 y6)
   (object-goal object4 x3 y2)
   (object-goal object4 x2 y6)
   ...
   (base-obstacle x5 y6)(surface x5 y6)
   ...
   (base-obstacle x10 y6)(gripper-obstacle x10 y6)
   ...
   (object-pos object0 x1 y8)
   (object-pos object1 x1 y9)
   (object-pos object2 x9 y6)
   (object-pos object3 x5 y6)
   (object-pos object4 x4 y2)
   (object-pos object5 x4 y6)
   (object-pos object6 x5 y7)
   (object-pos object7 x5 y9)
