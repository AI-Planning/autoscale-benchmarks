...
(define 
  ...
  (:init 
   ...
   (zerox-rel xrel0) 
   (zeroy-rel yrel0) 
   (object-goal object0 x3 y2)
   (object-goal object1 x3 y3)
   (object-goal object2 x4 y2)
   (object-goal object2 x11 y12)
   (object-goal object3 x4 y3)
   (object-goal object3 x9 y3)
   ...
   (base-obstacle x12 y10)(surface x12 y10)
   (base-obstacle x12 y11)(surface x12 y11)
   (base-obstacle x12 y12)(surface x12 y12)
   ...
   (base-obstacle x11 y7)(surface x11 y7)
   (base-obstacle x11 y8)(surface x11 y8)
   (base-obstacle x12 y6)(surface x12 y6)
   (base-obstacle x12 y7)(surface x12 y7)
   (base-obstacle x12 y8)(surface x12 y8)
   ...
   (object-pos object0 x7 y9)
   (object-pos object1 x1 y10)
   (object-pos object2 x12 y11)
   (object-pos object3 x1 y9)
   
   (gripper-empty pr2)
   (gripper-rel pr2 xrel0 yrel0)
   (gripper-obstacle x7 y9)
   (gripper-obstacle x1 y10)
   (gripper-obstacle x12 y11)
