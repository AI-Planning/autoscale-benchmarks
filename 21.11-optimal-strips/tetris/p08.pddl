(define (problem Tetris-16-4-7107012)
(:domain tetris)
(:objects  
...
straight0 straight1 straight2 straight3 straight4 straight5 straight6 - two_straight
rightl0 - right_l
)
(:init
...
(at_two straight1 f1-2f f2-2f)
(at_two straight2 f3-0f f4-0f)
(at_two straight3 f4-2f f5-2f)
(at_two straight4 f5-0f f6-0f)
(at_two straight5 f5-1f f6-1f)
(at_two straight6 f6-2f f7-2f)
(at_square square0 f0-0f)
(at_square square1 f3-2f)
(at_square square2 f4-1f)
(at_square square3 f7-0f)
(at_square square4 f7-1f)
 )
(:goal
(and
(clear f0-0f)
