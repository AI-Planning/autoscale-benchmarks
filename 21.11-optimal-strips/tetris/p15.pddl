(define (problem Tetris-20-2-513214)
(:domain tetris)
(:objects  
...
nothing- one_square
straight0 straight1 straight2 straight3 straight4 - two_straight
nisba- right_l
)
(:init
...
(clear f19-2f)
(clear f19-3f)
(at_two straight0 f9-0f f10-0f)
(at_two straight1 f1-3f f1-2f)
(at_two straight2 f7-3f f7-2f)
(at_two straight3 f0-3f f0-2f)
(at_two straight4 f3-0f f4-0f)
 )
(:goal
(and
(clear f0-0f)
