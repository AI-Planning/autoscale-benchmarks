(define (problem Tetris-16-2-426910)
(:domain tetris)
(:objects  
...
(clear f15-2f)
(clear f15-3f)
(at_two straight0 f1-2f f0-2f)
(at_two straight1 f7-3f f7-2f)
(at_two straight2 f6-1f f5-1f)
(at_two straight3 f4-1f f3-1f)
(at_two straight4 f5-0f f4-0f)
 )
(:goal
(and
(clear f0-0f)
