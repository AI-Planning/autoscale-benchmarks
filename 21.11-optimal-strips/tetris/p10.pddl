(define (problem Tetris-4-1-778643)
(:domain tetris)
(:objects  
...
square0 square1 square2 square3 square4 square5 square6 - one_square
nada- two_straight
nisba- right_l
)
(:init
...
(at_square square2 f0-3f)
(at_square square3 f1-2f)
(at_square square4 f0-2f)
(at_square square5 f0-0f)
(at_square square6 f2-0f)
 )
(:goal
(and
(clear f0-0f)
