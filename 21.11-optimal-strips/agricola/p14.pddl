(define (problem prob_agricola)
 (:domain agricola)
 (:objects 
num1 num2 num3 num4 num5 num6 num7 num8 num9 num10 num11 num12 num13 num14 num15 num16 num17 num18 num19 num20 num21 num22 num23 num24 num25 num26 num27 num28 - num 
...
worker1 worker2 worker3 worker4 worker5 worker6 worker7 worker8 worker9 worker10 worker11 worker12 worker13 - worker 
room1 room2 room3 room4 room5 room6 room7 room8 room9 room10 room11 room12 room13 - room 
 ...
 (:init 
    ...
    (NEXT_NUM num24 num25)
    (NEXT_NUM num25 num26)
    (NEXT_NUM num26 num27)
    (NEXT_NUM num27 num28)
    ...
    (NUM_SUBSTRACT num25 num1 num24)
    (NUM_SUBSTRACT num25 num2 num23)
    (NUM_SUBSTRACT num25 num3 num22)
    (NUM_SUBSTRACT num25 num4 num21)
    (NUM_SUBSTRACT num25 num5 num20)
    (NUM_SUBSTRACT num25 num6 num19)
    (NUM_SUBSTRACT num25 num7 num18)
    (NUM_SUBSTRACT num25 num8 num17)
    (NUM_SUBSTRACT num25 num9 num16)
    (NUM_SUBSTRACT num25 num10 num15)
    (NUM_SUBSTRACT num25 num11 num14)
    (NUM_SUBSTRACT num25 num12 num13)
    (NUM_SUBSTRACT num25 num13 num12)
    (NUM_SUBSTRACT num25 num14 num11)
    (NUM_SUBSTRACT num25 num15 num10)
    (NUM_SUBSTRACT num25 num16 num9)
    (NUM_SUBSTRACT num25 num17 num8)
    (NUM_SUBSTRACT num25 num18 num7)
    (NUM_SUBSTRACT num25 num19 num6)
    (NUM_SUBSTRACT num25 num20 num5)
    (NUM_SUBSTRACT num25 num21 num4)
    (NUM_SUBSTRACT num25 num22 num3)
    (NUM_SUBSTRACT num25 num23 num2)
    (NUM_SUBSTRACT num25 num24 num1)
    (NUM_SUBSTRACT num25 num25 num0)
    (NUM_SUBSTRACT num26 num1 num25)
    (NUM_SUBSTRACT num26 num2 num24)
    (NUM_SUBSTRACT num26 num3 num23)
    (NUM_SUBSTRACT num26 num4 num22)
    (NUM_SUBSTRACT num26 num5 num21)
    (NUM_SUBSTRACT num26 num6 num20)
    (NUM_SUBSTRACT num26 num7 num19)
    (NUM_SUBSTRACT num26 num8 num18)
    (NUM_SUBSTRACT num26 num9 num17)
    (NUM_SUBSTRACT num26 num10 num16)
    (NUM_SUBSTRACT num26 num11 num15)
    (NUM_SUBSTRACT num26 num12 num14)
    (NUM_SUBSTRACT num26 num13 num13)
    (NUM_SUBSTRACT num26 num14 num12)
    (NUM_SUBSTRACT num26 num15 num11)
    (NUM_SUBSTRACT num26 num16 num10)
    (NUM_SUBSTRACT num26 num17 num9)
    (NUM_SUBSTRACT num26 num18 num8)
    (NUM_SUBSTRACT num26 num19 num7)
    (NUM_SUBSTRACT num26 num20 num6)
    (NUM_SUBSTRACT num26 num21 num5)
    (NUM_SUBSTRACT num26 num22 num4)
    (NUM_SUBSTRACT num26 num23 num3)
    (NUM_SUBSTRACT num26 num24 num2)
    (NUM_SUBSTRACT num26 num25 num1)
    (NUM_SUBSTRACT num26 num26 num0)
    (NUM_SUBSTRACT num27 num1 num26)
    (NUM_SUBSTRACT num27 num2 num25)
    (NUM_SUBSTRACT num27 num3 num24)
    (NUM_SUBSTRACT num27 num4 num23)
    (NUM_SUBSTRACT num27 num5 num22)
    (NUM_SUBSTRACT num27 num6 num21)
    (NUM_SUBSTRACT num27 num7 num20)
    (NUM_SUBSTRACT num27 num8 num19)
    (NUM_SUBSTRACT num27 num9 num18)
    (NUM_SUBSTRACT num27 num10 num17)
    (NUM_SUBSTRACT num27 num11 num16)
    (NUM_SUBSTRACT num27 num12 num15)
    (NUM_SUBSTRACT num27 num13 num14)
    (NUM_SUBSTRACT num27 num14 num13)
    (NUM_SUBSTRACT num27 num15 num12)
    (NUM_SUBSTRACT num27 num16 num11)
    (NUM_SUBSTRACT num27 num17 num10)
    (NUM_SUBSTRACT num27 num18 num9)
    (NUM_SUBSTRACT num27 num19 num8)
    (NUM_SUBSTRACT num27 num20 num7)
    (NUM_SUBSTRACT num27 num21 num6)
    (NUM_SUBSTRACT num27 num22 num5)
    (NUM_SUBSTRACT num27 num23 num4)
    (NUM_SUBSTRACT num27 num24 num3)
    (NUM_SUBSTRACT num27 num25 num2)
    (NUM_SUBSTRACT num27 num26 num1)
    (NUM_SUBSTRACT num27 num27 num0)
    (NUM_SUBSTRACT num28 num1 num27)
    (NUM_SUBSTRACT num28 num2 num26)
    (NUM_SUBSTRACT num28 num3 num25)
    (NUM_SUBSTRACT num28 num4 num24)
    (NUM_SUBSTRACT num28 num5 num23)
    (NUM_SUBSTRACT num28 num6 num22)
    (NUM_SUBSTRACT num28 num7 num21)
    (NUM_SUBSTRACT num28 num8 num20)
    (NUM_SUBSTRACT num28 num9 num19)
    (NUM_SUBSTRACT num28 num10 num18)
    (NUM_SUBSTRACT num28 num11 num17)
    (NUM_SUBSTRACT num28 num12 num16)
    (NUM_SUBSTRACT num28 num13 num15)
    (NUM_SUBSTRACT num28 num14 num14)
    (NUM_SUBSTRACT num28 num15 num13)
    (NUM_SUBSTRACT num28 num16 num12)
    (NUM_SUBSTRACT num28 num17 num11)
    (NUM_SUBSTRACT num28 num18 num10)
    (NUM_SUBSTRACT num28 num19 num9)
    (NUM_SUBSTRACT num28 num20 num8)
    (NUM_SUBSTRACT num28 num21 num7)
    (NUM_SUBSTRACT num28 num22 num6)
    (NUM_SUBSTRACT num28 num23 num5)
    (NUM_SUBSTRACT num28 num24 num4)
    (NUM_SUBSTRACT num28 num25 num3)
    (NUM_SUBSTRACT num28 num26 num2)
    (NUM_SUBSTRACT num28 num27 num1)
    (NUM_SUBSTRACT num28 num28 num0)
    (NEXT2_NUM num0 num2)
    (NEXT2_NUM num1 num3)
    (NEXT2_NUM num2 num4)
    (NEXT2_NUM num3 num5)
    ...
    (NEXT2_NUM num23 num25)
    (NEXT2_NUM num24 num26)
    (NEXT2_NUM num25 num27)
    (NEXT2_NUM num26 num28)
    ...
    (NEXT_WORKER worker13 worker12)
    (NEXT_WORKER worker12 worker11)
    ...
    (FOOD_REQUIRED worker12 num24)
    (FOOD_REQUIRED worker12 num25)
    (FOOD_REQUIRED worker13 num26)
    (FOOD_REQUIRED worker13 num27)
    ...
    (space_rooms room12)
    (space_rooms room13)
    (= (group_worker_cost worker2) 270)
    (= (group_worker_cost worker3) 240)
    (= (group_worker_cost worker4) 210)
    (= (group_worker_cost worker5) 180)
    (= (group_worker_cost worker6) 150)
    (= (group_worker_cost worker7) 120)
    (= (group_worker_cost worker8) 90)
    (= (group_worker_cost worker9) 60)
    (= (group_worker_cost worker10) 30)
    (= (group_worker_cost worker11) 15)
    (= (group_worker_cost worker12) 6)
    (= (group_worker_cost worker13) 4))
 (:goal (and 
