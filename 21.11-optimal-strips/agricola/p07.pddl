(define (problem prob_agricola)
 (:domain agricola)
 (:objects 
num1 num2 num3 num4 num5 num6 num7 num8 num9 num10 num11 num12 num13 num14 num15 num16 num17 num18 num19 num20 num21 num22 num23 num24 num25 num26 - num 
...
worker1 worker2 worker3 worker4 worker5 worker6 worker7 worker8 worker9 worker10 worker11 worker12 - worker 
room1 room2 room3 room4 room5 room6 room7 room8 room9 room10 room11 room12 - room 
 ...
 (:init 
    ...
    (space_rooms room11)
    (space_rooms room12)
    (= (group_worker_cost worker2) 240)
    (= (group_worker_cost worker3) 210)
    (= (group_worker_cost worker4) 180)
    (= (group_worker_cost worker5) 150)
    (= (group_worker_cost worker6) 120)
    (= (group_worker_cost worker7) 90)
    (= (group_worker_cost worker8) 60)
    (= (group_worker_cost worker9) 30)
    (= (group_worker_cost worker10) 15)
    (= (group_worker_cost worker11) 6)
    (= (group_worker_cost worker12) 4))
 (:goal (and 
